<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FolioWebApplication.HoldingType2s.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="HoldingType2Panel" runat="server">
        <fieldset>
            <legend>
                <asp:HyperLink ID="HoldingType2HyperLink" runat="server" Text="Holding Type" NavigateUrl="Default.aspx" /></legend>
            <asp:FormView ID="HoldingType2FormView" runat="server" DataKeyNames="Id" DefaultMode="ReadOnly" RenderOuterTable="false" OnDataBinding="HoldingType2FormView_DataBinding">
                <ItemTemplate>
                    <asp:Panel ID="ViewHoldingType2Panel" runat="server">
                        <table>
    ...
    <asp:Panel ID="Holding2sPanel" runat="server" Visible='<%# (string)Session["Holding2sPermission"] != null && HoldingType2FormView.DataKey.Value != null %>'>
        <fieldset>
            <legend>
