<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FolioWebApplication.BoundWithPart2s.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="BoundWithPart2Panel" runat="server">
        <fieldset>
            <legend>
                <asp:HyperLink ID="BoundWithPart2HyperLink" runat="server" Text="Bound With Part" NavigateUrl="Default.aspx" /></legend>
            <asp:FormView ID="BoundWithPart2FormView" runat="server" DataKeyNames="Id" DefaultMode="ReadOnly" RenderOuterTable="false" OnDataBinding="BoundWithPart2FormView_DataBinding">
                <ItemTemplate>
                    <asp:Panel ID="ViewBoundWithPart2Panel" runat="server">
                        <table>
