...
namespace FolioWebApplication.Proxy2s
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void ExportLinkButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (var p2 in folioServiceContext.Proxy2s(Global.GetCqlFilter(Proxy2sRadGrid, d), Proxy2sRadGrid.MasterTableView.SortExpressions.Count > 0 ? $"{d[Proxy2sRadGrid.MasterTableView.SortExpressions[0].FieldName]}{(Proxy2sRadGrid.MasterTableView.SortExpressions[0].SortOrder == GridSortOrder.Descending ? "/sort.descending" : "")}" : null, load: true))
