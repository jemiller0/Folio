                ...
                <ItemTemplate>
                    <asp:Panel ID="ViewTransaction2Panel" runat="server">
                        <table>
                            ...
                            <tr runat="server" visible='<%# Eval("EncumbranceAmountCredited") != null %>'>
                                <td>
                                    <asp:Label ID="EncumbranceAmountCreditedLabel" runat="server" Text="Encumbrance Amount Credited:" AssociatedControlID="EncumbranceAmountCreditedLiteral" />
                                </td>
                                <td>
                                    <asp:Literal ID="EncumbranceAmountCreditedLiteral" runat="server" Text='<%# Eval("EncumbranceAmountCredited", "{0:c}") %>' />
                                </td>
                            </tr>
                            ...
                            <tr runat="server" visible='<%# Eval("VoidedAmount") != null %>'>
                                <td>
                                    <asp:Label ID="VoidedAmountLabel" runat="server" Text="Voided Amount:" AssociatedControlID="VoidedAmountLiteral" />
                                </td>
                                <td>
                                    <asp:Literal ID="VoidedAmountLiteral" runat="server" Text='<%# Eval("VoidedAmount", "{0:c}") %>' />
                                </td>
                            </tr>
