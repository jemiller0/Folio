    ...
    public partial class Edit : System.Web.UI.Page
    {
        ...
        protected void LoanPolicy2s1RadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var where = Global.Trim(string.Join(" and ", new string[]
            {
                ...
                Global.GetCqlFilter(LoanPolicy2s1RadGrid, "LoansPolicyForUseAtLocation", "loansPolicy.forUseAtLocation"),
                Global.GetCqlFilter(LoanPolicy2s1RadGrid, "LoansPolicyHoldShelfExpiryPeriodForUseAtLocationDuration", "loansPolicy.holdShelfExpiryPeriodForUseAtLocation.duration"),
                Global.GetCqlFilter(LoanPolicy2s1RadGrid, "LoansPolicyHoldShelfExpiryPeriodForUseAtLocationInterval", "loansPolicy.holdShelfExpiryPeriodForUseAtLocation.intervalId"),
