<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FolioWebApplication.SubjectSource2s.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="SubjectSource2Panel" runat="server">
        <fieldset>
            <legend>
                <asp:HyperLink ID="SubjectSource2HyperLink" runat="server" Text="Subject Source" NavigateUrl="Default.aspx" /></legend>
            <asp:FormView ID="SubjectSource2FormView" runat="server" DataKeyNames="Id" DefaultMode="ReadOnly" RenderOuterTable="false" OnDataBinding="SubjectSource2FormView_DataBinding">
                <ItemTemplate>
                    <asp:Panel ID="ViewSubjectSource2Panel" runat="server">
                        <table>
