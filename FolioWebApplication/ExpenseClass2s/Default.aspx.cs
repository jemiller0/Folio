...
namespace FolioWebApplication.ExpenseClass2s
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            var d = new Dictionary<string, string>() { { "Id", "id" }, { "Code", "code" }, { "ExternalAccountNumberExtension", "externalAccountNumberExt" }, { "Name", "name" }, { "CreationTime", "metadata.createdDate" }, { "CreationUserId", "metadata.createdByUserId" }, { "LastWriteTime", "metadata.updatedDate" }, { "LastWriteUserId", "metadata.updatedByUserId" } };
        ...
        protected void ExportLinkButton_Click(object sender, EventArgs e)
        {
            ...
            var d = new Dictionary<string, string>() { { "Id", "id" }, { "Code", "code" }, { "ExternalAccountNumberExtension", "externalAccountNumberExt" }, { "Name", "name" }, { "CreationTime", "metadata.createdDate" }, { "CreationUserId", "metadata.createdByUserId" }, { "LastWriteTime", "metadata.updatedDate" }, { "LastWriteUserId", "metadata.updatedByUserId" } };
            Response.Write("Id\tCode\tExternalAccountNumberExtension\tName\tCreationTime\tCreationUser\tCreationUserId\tLastWriteTime\tLastWriteUser\tLastWriteUserId\r\n");
