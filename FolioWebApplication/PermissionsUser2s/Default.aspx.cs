...
namespace FolioWebApplication.PermissionsUser2s
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void ExportLinkButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (var pu2 in folioServiceContext.PermissionsUser2s(where, PermissionsUser2sRadGrid.MasterTableView.SortExpressions.Count > 0 ? $"{d[PermissionsUser2sRadGrid.MasterTableView.SortExpressions[0].FieldName]}{(PermissionsUser2sRadGrid.MasterTableView.SortExpressions[0].SortOrder == GridSortOrder.Descending ? "/sort.descending" : "")}" : null, load: true))
