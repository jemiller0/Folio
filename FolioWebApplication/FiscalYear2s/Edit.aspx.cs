    ...
    public partial class Edit : System.Web.UI.Page
    {
        ...
        protected void Order2sRadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            if (Order2sRadGrid.MasterTableView.FilterExpression == "")
            {
                ...
                Order2sPanel.Visible = FiscalYear2FormView.DataKey.Value != null && Session["Order2sPermission"] != null && Order2sRadGrid.VirtualItemCount > 0;
            }
            traceSource.TraceEvent(TraceEventType.Verbose, 0, $"where = {where}");
        }
        ...
        protected void OrderItem2sRadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var where = Global.Trim(string.Join(" and ", new string[]
            {
                $"paymentTerms.startingFiscalYearId == \"{id}\"",
            ...
            if (OrderItem2sRadGrid.MasterTableView.FilterExpression == "")
            {
                ...
                OrderItem2sPanel.Visible = FiscalYear2FormView.DataKey.Value != null && Session["OrderItem2sPermission"] != null && OrderItem2sRadGrid.VirtualItemCount > 0;
            }
            traceSource.TraceEvent(TraceEventType.Verbose, 0, $"where = {where}");
        }
