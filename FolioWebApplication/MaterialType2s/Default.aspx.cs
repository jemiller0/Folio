...
namespace FolioWebApplication.MaterialType2s
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void ExportLinkButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (var mt2 in folioServiceContext.MaterialType2s(where, MaterialType2sRadGrid.MasterTableView.SortExpressions.Count > 0 ? $"{d[MaterialType2sRadGrid.MasterTableView.SortExpressions[0].FieldName]}{(MaterialType2sRadGrid.MasterTableView.SortExpressions[0].SortOrder == GridSortOrder.Descending ? "/sort.descending" : "")}" : null, load: true))
