<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FolioWebApplication.AcquisitionMethod2s.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="AcquisitionMethod2Panel" runat="server">
        <fieldset>
            <legend>
                <asp:HyperLink ID="AcquisitionMethod2HyperLink" runat="server" Text="Acquisition Method" NavigateUrl="Default.aspx" /></legend>
            <asp:FormView ID="AcquisitionMethod2FormView" runat="server" DataKeyNames="Id" DefaultMode="ReadOnly" RenderOuterTable="false" OnDataBinding="AcquisitionMethod2FormView_DataBinding">
                <ItemTemplate>
                    <asp:Panel ID="ViewAcquisitionMethod2Panel" runat="server">
                        <table>
    ...
    <asp:Panel ID="OrderItem2sPanel" runat="server" Visible='<%# (string)Session["OrderItem2sPermission"] != null && AcquisitionMethod2FormView.DataKey.Value != null %>'>
        <fieldset>
            <legend>
