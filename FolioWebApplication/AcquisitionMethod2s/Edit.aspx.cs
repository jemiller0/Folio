...
namespace FolioWebApplication.AcquisitionMethod2s
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        protected void AcquisitionMethod2FormView_DataBinding(object sender, EventArgs e)
        {
            var id = Request.QueryString["Id"] != null ? (Guid?)Guid.Parse(Request.QueryString["Id"]) : null;
            var am2 = folioServiceContext.FindAcquisitionMethod2(id, true);
            if (am2 == null) Response.Redirect("Default.aspx");
            am2.Content = am2.Content != null ? JsonConvert.DeserializeObject<JToken>(am2.Content, new JsonSerializerSettings { DateTimeZoneHandling = DateTimeZoneHandling.Local }).ToString() : null;
            AcquisitionMethod2FormView.DataSource = new[] { am2 };
            Title = $"Acquisition Method {am2.Name}";
        }
        ...
        protected void OrderItem2sRadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var id = (Guid?)AcquisitionMethod2FormView.DataKey.Value;
            if (id == null) return;
            ...
            if (OrderItem2sRadGrid.MasterTableView.FilterExpression == "")
            {
                ...
                OrderItem2sPanel.Visible = AcquisitionMethod2FormView.DataKey.Value != null && Session["OrderItem2sPermission"] != null && OrderItem2sRadGrid.VirtualItemCount > 0;
            }
