...
namespace FolioWebApplication.DateType2s
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        protected void DateType2FormView_DataBinding(object sender, EventArgs e)
        {
            var id = Request.QueryString["Id"] != null ? (Guid?)Guid.Parse(Request.QueryString["Id"]) : null;
            var dt2 = folioServiceContext.FindDateType2(id, true);
            if (dt2 == null) Response.Redirect("Default.aspx");
            dt2.Content = dt2.Content != null ? JsonConvert.DeserializeObject<JToken>(dt2.Content, new JsonSerializerSettings { DateTimeZoneHandling = DateTimeZoneHandling.Local }).ToString() : null;
            DateType2FormView.DataSource = new[] { dt2 };
            Title = $"Date Type {dt2.Name}";
        }
        ...
        protected void Instance2sRadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var id = (Guid?)DateType2FormView.DataKey.Value;
            if (id == null) return;
            ...
            if (Instance2sRadGrid.MasterTableView.FilterExpression == "")
            {
                ...
                Instance2sPanel.Visible = DateType2FormView.DataKey.Value != null && Session["Instance2sPermission"] != null && Instance2sRadGrid.VirtualItemCount > 0;
            }
