<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FolioWebApplication.DateType2s.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="DateType2Panel" runat="server">
        <fieldset>
            <legend>
                <asp:HyperLink ID="DateType2HyperLink" runat="server" Text="Date Type" NavigateUrl="Default.aspx" /></legend>
            <asp:FormView ID="DateType2FormView" runat="server" DataKeyNames="Id" DefaultMode="ReadOnly" RenderOuterTable="false" OnDataBinding="DateType2FormView_DataBinding">
                <ItemTemplate>
                    <asp:Panel ID="ViewDateType2Panel" runat="server">
                        <table>
                            ...
                            <tr runat="server" visible='<%# Eval("DisplayFormatDelimiter") != null %>'>
                                <td>
                                    <asp:Label ID="DisplayFormatDelimiterLabel" runat="server" Text="Display Format Delimiter:" AssociatedControlID="DisplayFormatDelimiterLiteral" />
                                </td>
                                <td>
                                    <asp:Literal ID="DisplayFormatDelimiterLiteral" runat="server" Text='<%#: Eval("DisplayFormatDelimiter") %>' />
                                </td>
                            </tr>
                            <tr runat="server" visible='<%# Eval("DisplayFormatKeepDelimiter") != null %>'>
                                <td>
                                    <asp:Label ID="DisplayFormatKeepDelimiterLabel" runat="server" Text="Display Format Keep Delimiter:" AssociatedControlID="DisplayFormatKeepDelimiterLiteral" />
                                </td>
                                <td>
                                    <asp:Literal ID="DisplayFormatKeepDelimiterLiteral" runat="server" Text='<%#: Eval("DisplayFormatKeepDelimiter") %>' />
                                </td>
                            </tr>
    ...
    <asp:Panel ID="Instance2sPanel" runat="server" Visible='<%# (string)Session["Instance2sPermission"] != null && DateType2FormView.DataKey.Value != null %>'>
        <fieldset>
            <legend>
