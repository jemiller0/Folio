<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FolioWebApplication.RolloverProgress2s.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="RolloverProgress2Panel" runat="server">
        <fieldset>
            <legend>
                <asp:HyperLink ID="RolloverProgress2HyperLink" runat="server" Text="Rollover Progress" NavigateUrl="Default.aspx" /></legend>
            <asp:FormView ID="RolloverProgress2FormView" runat="server" DataKeyNames="Id" DefaultMode="ReadOnly" RenderOuterTable="false" OnDataBinding="RolloverProgress2FormView_DataBinding">
                <ItemTemplate>
                    <asp:Panel ID="ViewRolloverProgress2Panel" runat="server">
                        <table>
