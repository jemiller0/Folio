    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void User2sRadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var where = Global.Trim(string.Join(" and ", new string[]
            {
                ...
                Global.GetCqlFilter(User2sRadGrid, "SourceId", "customFields.dataSource"),
                Global.GetCqlFilter(User2sRadGrid, "CategoryCode", "customFields.category"),
                Global.GetCqlFilter(User2sRadGrid, "CategoryId", "customFields.statCategory"),
        ...
        protected void ExportLinkButton_Click(object sender, EventArgs e)
        {
            ...
            Response.Write("Id\tUsername\tExternalSystemId\tBarcode\tActive\tGroup\tGroupId\tPronouns\tName\tLastName\tFirstName\tMiddleName\tPreferredFirstName\tEmailAddress\tPhoneNumber\tMobilePhoneNumber\tBirthDate\tPreferredContactType\tPreferredContactTypeId\tProfilePictureLink\tStartDate\tEndDate\tSource\tSourceId\tCategoryCode\tCategoryId\tStatus\tStatuses\tStaffStatus\tStaffPrivileges\tStaffDivision\tStaffDepartment\tStudentId\tStudentStatus\tStudentRestriction\tStudentDivision\tStudentDepartment\tDeceased\tCollections\tCreationTime\tCreationUser\tCreationUserId\tLastWriteTime\tLastWriteUser\tLastWriteUserId\r\n");
            var d = new Dictionary<string, string>() { { "Id", "id" }, { "Username", "username" }, { "ExternalSystemId", "externalSystemId" }, { "Barcode", "barcode" }, { "Active", "active" }, { "GroupId", "patronGroup" }, { "Pronouns", "personal.pronouns" }, { "LastName", "personal.lastName" }, { "FirstName", "personal.firstName" }, { "MiddleName", "personal.middleName" }, { "PreferredFirstName", "personal.preferredFirstName" }, { "EmailAddress", "personal.email" }, { "PhoneNumber", "personal.phone" }, { "MobilePhoneNumber", "personal.mobilePhone" }, { "BirthDate", "personal.dateOfBirth" }, { "PreferredContactTypeId", "personal.preferredContactTypeId" }, { "ProfilePictureLink", "personal.profilePictureLink" }, { "StartDate", "enrollmentDate" }, { "EndDate", "expirationDate" }, { "Source", "customFields.source" }, { "SourceId", "customFields.dataSource" }, { "CategoryCode", "customFields.category" }, { "CategoryId", "customFields.statCategory" }, { "Status", "customFields.status" }, { "Statuses", "customFields.statuses" }, { "StaffStatus", "customFields.staffStatus" }, { "StaffPrivileges", "customFields.staffPrivileges" }, { "StaffDivision", "customFields.staffDivision" }, { "StaffDepartment", "customFields.staffDepartment" }, { "StudentId", "customFields.studentId" }, { "StudentStatus", "customFields.studentStatus" }, { "StudentRestriction", "customFields.studentRestriction" }, { "StudentDivision", "customFields.studentDivision" }, { "StudentDepartment", "customFields.studentDepartment" }, { "Deceased", "customFields.deceased" }, { "Collections", "customFields.collections" }, { "CreationTime", "metadata.createdDate" }, { "CreationUserId", "metadata.createdByUserId" }, { "LastWriteTime", "metadata.updatedDate" }, { "LastWriteUserId", "metadata.updatedByUserId" } };
            var where = Global.Trim(string.Join(" and ", new string[]
            {
                Global.GetCqlFilter(User2sRadGrid, "Id", "id"),
