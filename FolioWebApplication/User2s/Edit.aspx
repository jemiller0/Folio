...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <ItemTemplate>
                    <asp:Panel ID="ViewUser2Panel" runat="server">
                        <table>
                            ...
                            <tr runat="server" visible='<%# Eval("Pronouns") != null %>'>
                                <td>
                                    <asp:Label ID="PronounsLabel" runat="server" Text="Pronouns:" AssociatedControlID="PronounsLiteral" />
                                </td>
                                <td>
                                    <asp:Literal ID="PronounsLiteral" runat="server" Text='<%#: Eval("Pronouns") %>' />
                                </td>
                            </tr>
                            ...
                            <tr runat="server" visible='<%# Eval("ProfilePictureLink") != null %>'>
                                <td>
                                    <asp:Label ID="ProfilePictureLinkLabel" runat="server" Text="Profile Picture Link:" AssociatedControlID="ProfilePictureLinkLiteral" />
                                </td>
                                <td>
                                    <asp:Literal ID="ProfilePictureLinkLiteral" runat="server" Text='<%#: Eval("ProfilePictureLink") %>' />
                                </td>
                            </tr>
                ...
                <EditItemTemplate>
                    <asp:Panel ID="EditUser2Panel" runat="server" DefaultButton="InsertUpdateRadButton">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="PronounsLabel" runat="server" Text="Pronouns:" AssociatedControlID="PronounsRadTextBox" />
                                </td>
                                <td>
                                    <telerik:RadTextBox ID="PronounsRadTextBox" runat="server" Text='<%# Bind("Pronouns") %>' MaxLength="300" Width="500px" />
                                </td>
                            </tr>
                            <tr runat="server" visible='<%# Eval("Name") != null %>'>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="ProfilePictureLinkLabel" runat="server" Text="Profile Picture Link:" AssociatedControlID="ProfilePictureLinkRadTextBox" />
                                </td>
                                <td>
                                    <telerik:RadTextBox ID="ProfilePictureLinkRadTextBox" runat="server" Text='<%# Bind("ProfilePictureLink") %>' MaxLength="1024" Width="500px" />
                                </td>
                            </tr>
                            <tr>
                                <td>
    ...
    <asp:Panel ID="Order2s4Panel" runat="server" Visible='<%# (string)Session["Order2sPermission"] != null && User2FormView.DataKey.Value != null %>'>
        <fieldset>
            <legend>
                <asp:HyperLink ID="Order2s4HyperLink" runat="server" Text="Orders 4" NavigateUrl="~/Order2s/Default.aspx" /></legend>
            <telerik:RadGrid ID="Order2s4RadGrid" runat="server" AutoGenerateColumns="false" AllowSorting="true" AllowFilteringByColumn="false" GroupingSettings-CaseSensitive="false" AllowPaging="true" AllowCustomPaging="true" PageSize="10" EnableLinqExpressions="false" OnNeedDataSource="Order2s4RadGrid_NeedDataSource">
                <MasterTableView DataKeyNames="Id" PagerStyle-Mode="NextPrevNumericAndAdvanced" NoMasterRecordsText="No orders found">
                    <SortExpressions>
                        <telerik:GridSortExpression FieldName="LastWriteTime" SortOrder="Descending" />
                    </SortExpressions>
    ...
    <asp:Panel ID="PreferredEmailCommunicationsPanel" runat="server" Visible='<%# (string)Session["PreferredEmailCommunicationsPermission"] != null && User2FormView.DataKey.Value != null %>'>
        <fieldset>
            <legend>
                <asp:HyperLink ID="PreferredEmailCommunicationsHyperLink" runat="server" Text="Preferred Email Communications" NavigateUrl="~/PreferredEmailCommunications/Default.aspx" Enabled="false" /></legend>
            <telerik:RadGrid ID="PreferredEmailCommunicationsRadGrid" runat="server" AutoGenerateColumns="false" AllowSorting="true" AllowFilteringByColumn="false" GroupingSettings-CaseSensitive="false" AllowPaging="true" PageSize="10" EnableLinqExpressions="false" OnNeedDataSource="PreferredEmailCommunicationsRadGrid_NeedDataSource">
                <MasterTableView DataKeyNames="Id" PagerStyle-Mode="NextPrevNumericAndAdvanced" NoMasterRecordsText="No preferred email communications found">
                    <SortExpressions>
    ...
    <asp:Panel ID="Request2s1Panel" runat="server" Visible='<%# (string)Session["Request2sPermission"] != null && User2FormView.DataKey.Value != null %>'>
        <fieldset>
            <legend>
                <asp:HyperLink ID="Request2s1HyperLink" runat="server" Text="Requests 1" NavigateUrl="~/Request2s/Default.aspx" /></legend>
            <telerik:RadGrid ID="Request2s1RadGrid" runat="server" AutoGenerateColumns="false" AllowSorting="true" AllowFilteringByColumn="false" GroupingSettings-CaseSensitive="false" AllowPaging="true" AllowCustomPaging="true" PageSize="10" EnableLinqExpressions="false" OnNeedDataSource="Request2s1RadGrid_NeedDataSource">
                <MasterTableView DataKeyNames="Id" PagerStyle-Mode="NextPrevNumericAndAdvanced" NoMasterRecordsText="No requests found">
                    <SortExpressions>
                        <telerik:GridSortExpression FieldName="LastWriteTime" SortOrder="Descending" />
                    </SortExpressions>
    ...
    <asp:Panel ID="Request2s4Panel" runat="server" Visible='<%# (string)Session["Request2sPermission"] != null && User2FormView.DataKey.Value != null %>'>
        <fieldset>
            <legend>
                <asp:HyperLink ID="Request2s4HyperLink" runat="server" Text="Requests 4" NavigateUrl="~/Request2s/Default.aspx" /></legend>
            <telerik:RadGrid ID="Request2s4RadGrid" runat="server" AutoGenerateColumns="false" AllowSorting="true" AllowFilteringByColumn="false" GroupingSettings-CaseSensitive="false" AllowPaging="true" AllowCustomPaging="true" PageSize="10" EnableLinqExpressions="false" OnNeedDataSource="Request2s4RadGrid_NeedDataSource">
                <MasterTableView DataKeyNames="Id" PagerStyle-Mode="NextPrevNumericAndAdvanced" NoMasterRecordsText="No requests found">
                    <SortExpressions>
                        <telerik:GridSortExpression FieldName="LastWriteTime" SortOrder="Descending" />
                    </SortExpressions>
    ...
    <asp:Panel ID="UserAddressesPanel" runat="server" Visible='<%# (string)Session["UserAddressesPermission"] != null && User2FormView.DataKey.Value != null %>'>
        <fieldset>
            <legend>
                <asp:HyperLink ID="UserAddressesHyperLink" runat="server" Text="User Addresses" NavigateUrl="~/UserAddresses/Default.aspx" Enabled="false" /></legend>
            <telerik:RadGrid ID="UserAddressesRadGrid" runat="server" AutoGenerateColumns="false" AllowSorting="true" AllowFilteringByColumn="false" GroupingSettings-CaseSensitive="false" AllowPaging="true" PageSize="10" EnableLinqExpressions="false" OnNeedDataSource="UserAddressesRadGrid_NeedDataSource">
                <MasterTableView DataKeyNames="Id" PagerStyle-Mode="NextPrevNumericAndAdvanced" NoMasterRecordsText="No user addresses found">
                    <SortExpressions>
                        <telerik:GridSortExpression FieldName="StreetAddress1" />
                    </SortExpressions>
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Address Type" DataField="AddressType.Name" AllowSorting="false" AutoPostBackOnFilter="true" CurrentFilterFunction="StartsWith">
                            <ItemTemplate>
    ...
    <asp:Panel ID="UserDepartmentsPanel" runat="server" Visible='<%# (string)Session["UserDepartmentsPermission"] != null && User2FormView.DataKey.Value != null %>'>
        <fieldset>
            <legend>
                <asp:HyperLink ID="UserDepartmentsHyperLink" runat="server" Text="User Departments" NavigateUrl="~/UserDepartments/Default.aspx" Enabled="false" /></legend>
            <telerik:RadGrid ID="UserDepartmentsRadGrid" runat="server" AutoGenerateColumns="false" AllowSorting="true" AllowFilteringByColumn="false" GroupingSettings-CaseSensitive="false" AllowPaging="true" PageSize="10" EnableLinqExpressions="false" OnNeedDataSource="UserDepartmentsRadGrid_NeedDataSource">
                <MasterTableView DataKeyNames="Id" PagerStyle-Mode="NextPrevNumericAndAdvanced" NoMasterRecordsText="No user departments found">
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Department" DataField="Department.Name" AllowSorting="false" AutoPostBackOnFilter="true" CurrentFilterFunction="StartsWith">
                            <ItemTemplate>
    ...
    <asp:Panel ID="UserTagsPanel" runat="server" Visible='<%# (string)Session["UserTagsPermission"] != null && User2FormView.DataKey.Value != null %>'>
        <fieldset>
            <legend>
                <asp:HyperLink ID="UserTagsHyperLink" runat="server" Text="User Tags" NavigateUrl="~/UserTags/Default.aspx" Enabled="false" /></legend>
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="Order2s4RadGrid">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Order2s4Panel" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="PreferredEmailCommunicationsRadGrid">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="PreferredEmailCommunicationsPanel" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="Request2s1RadGrid">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Request2s1Panel" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="Request2s4RadGrid">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Request2s4Panel" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
