...
namespace FolioWebApplication.User2s
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        protected void User2FormView_ItemUpdating(object sender, FormViewUpdateEventArgs e)
        {
            ...
            u2.SourceId = Global.Trim((string)e.NewValues["SourceId"]);
            u2.CategoryCode = Global.Trim((string)e.NewValues["CategoryCode"]);
            u2.CategoryId = Global.Trim((string)e.NewValues["CategoryId"]);
        ...
        protected void User2FormView_ItemDeleting(object sender, FormViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (folioServiceContext.AnyOrganizationType2s($"metadata.createdByUserId == \"{id}\"")) throw new Exception("User cannot be deleted because it is being referenced by a organization type");
                if (folioServiceContext.AnyOrganizationType2s($"metadata.updatedByUserId == \"{id}\"")) throw new Exception("User cannot be deleted because it is being referenced by a organization type");
        ...
        protected void Loan2s3RadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var where = Global.Trim(string.Join(" and ", new string[]
            {
                ...
                Global.GetCqlFilter(Loan2s3RadGrid, "ForUseAtLocationStatus", "forUseAtLocation.status"),
                Global.GetCqlFilter(Loan2s3RadGrid, "ForUseAtLocationStatusDate", "forUseAtLocation.statusDate"),
                Global.GetCqlFilter(Loan2s3RadGrid, "ForUseAtLocationHoldShelfExpirationDate", "forUseAtLocation.holdShelfExpirationDate"),
        ...
        protected void Request2s3RadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var where = Global.Trim(string.Join(" and ", new string[]
            {
                ...
                Global.GetCqlFilter(Request2s3RadGrid, "ItemItemEffectiveLocation.Name", "item.itemEffectiveLocationId", "name", folioServiceContext.FolioServiceClient.Locations),
                Global.GetCqlFilter(Request2s3RadGrid, "ItemRetrievalServicePoint.Name", "item.retrievalServicePointId", "name", folioServiceContext.FolioServiceClient.ServicePoints),
                ...
                Global.GetCqlFilter(Request2s3RadGrid, "IsDcbReRequestCancellation", "isDcbReRequestCancellation")
            }.Where(s => s != null)));
        ...
        protected void Request2s4RadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var where = Global.Trim(string.Join(" and ", new string[]
            {
                ...
                Global.GetCqlFilter(Request2s4RadGrid, "ItemItemEffectiveLocation.Name", "item.itemEffectiveLocationId", "name", folioServiceContext.FolioServiceClient.Locations),
                Global.GetCqlFilter(Request2s4RadGrid, "ItemRetrievalServicePoint.Name", "item.retrievalServicePointId", "name", folioServiceContext.FolioServiceClient.ServicePoints),
                ...
                Global.GetCqlFilter(Request2s4RadGrid, "IsDcbReRequestCancellation", "isDcbReRequestCancellation")
            }.Where(s => s != null)));
