<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FolioWebApplication.Formats.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="FormatPanel" runat="server">
        <fieldset>
            <legend>
                <asp:HyperLink ID="FormatHyperLink" runat="server" Text="Format" NavigateUrl="Default.aspx" /></legend>
            <asp:FormView ID="FormatFormView" runat="server" DataKeyNames="Id" DefaultMode="ReadOnly" RenderOuterTable="false" OnDataBinding="FormatFormView_DataBinding">
                <ItemTemplate>
                    <asp:Panel ID="ViewFormatPanel" runat="server">
                        <table>
