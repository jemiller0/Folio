<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FolioWebApplication.RelationshipTypes.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="RelationshipTypePanel" runat="server">
        <fieldset>
            <legend>
                <asp:HyperLink ID="RelationshipTypeHyperLink" runat="server" Text="Relationship Type" NavigateUrl="Default.aspx" /></legend>
            <asp:FormView ID="RelationshipTypeFormView" runat="server" DataKeyNames="Id" DefaultMode="ReadOnly" RenderOuterTable="false" OnDataBinding="RelationshipTypeFormView_DataBinding">
                <ItemTemplate>
                    <asp:Panel ID="ViewRelationshipTypePanel" runat="server">
                        <table>
    ...
    <asp:Panel ID="InstanceRelationshipsPanel" runat="server" Visible='<%# (string)Session["RelationshipsPermission"] != null && RelationshipTypeFormView.DataKey.Value != null %>'>
        <fieldset>
            <legend>
                <asp:HyperLink ID="InstanceRelationshipsHyperLink" runat="server" Text="Instance Relationships" NavigateUrl="~/Relationships/Default.aspx" /></legend>
            <telerik:RadGrid ID="InstanceRelationshipsRadGrid" runat="server" AutoGenerateColumns="false" AllowSorting="true" AllowFilteringByColumn="false" GroupingSettings-CaseSensitive="false" AllowPaging="true" AllowCustomPaging="true" PageSize="10" EnableLinqExpressions="false" OnNeedDataSource="InstanceRelationshipsRadGrid_NeedDataSource">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="InstanceRelationshipsRadGrid">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="InstanceRelationshipsPanel" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
