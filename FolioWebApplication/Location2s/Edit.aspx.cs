    ...
    public partial class Edit : System.Web.UI.Page
    {
        ...
        protected void Holding2s1RadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var where = Global.Trim(string.Join(" and ", new string[]
            {
                ...
                Global.GetCqlFilter(Holding2s1RadGrid, "Version", "_version"),
        ...
        protected void Holding2s2RadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var where = Global.Trim(string.Join(" and ", new string[]
            {
                ...
                Global.GetCqlFilter(Holding2s2RadGrid, "Version", "_version"),
        ...
        protected void Item2s2RadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var where = Global.Trim(string.Join(" and ", new string[]
            {
                ...
                Global.GetCqlFilter(Item2s2RadGrid, "Version", "_version"),
                ...
                Global.GetCqlFilter(Item2s2RadGrid, "StatusName", "status.name"),
                Global.GetCqlFilter(Item2s2RadGrid, "StatusDate", "status.date"),
