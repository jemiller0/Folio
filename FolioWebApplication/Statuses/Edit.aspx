<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FolioWebApplication.Statuses.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="StatusPanel" runat="server">
        <fieldset>
            <legend>
                <asp:HyperLink ID="StatusHyperLink" runat="server" Text="Status" NavigateUrl="Default.aspx" /></legend>
            <asp:FormView ID="StatusFormView" runat="server" DataKeyNames="Id" DefaultMode="ReadOnly" RenderOuterTable="false" OnDataBinding="StatusFormView_DataBinding">
                <ItemTemplate>
                    <asp:Panel ID="ViewStatusPanel" runat="server">
                        <table>
    ...
    <asp:Panel ID="Instance2sPanel" runat="server" Visible='<%# (string)Session["Instance2sPermission"] != null && StatusFormView.DataKey.Value != null %>'>
        <fieldset>
            <legend>
                ...
                <MasterTableView DataKeyNames="Id" PagerStyle-Mode="NextPrevNumericAndAdvanced" NoMasterRecordsText="No instances found">
                    <Columns>
                        <telerik:GridTemplateColumn AllowFiltering="false" ItemStyle-Width="0px">
                            <ItemTemplate>
                                <asp:HyperLink ID="EditViewHyperLink" Text='<%# Session["Instance2sPermission"] %>' NavigateUrl='<%# $"~/Instance2s/Edit.aspx?Id={Eval("Id")}" %>' runat="server" />
                            </ItemTemplate>
