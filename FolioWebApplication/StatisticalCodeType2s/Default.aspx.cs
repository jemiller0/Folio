...
namespace FolioWebApplication.StatisticalCodeType2s
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void ExportLinkButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (var sct2 in folioServiceContext.StatisticalCodeType2s(where, StatisticalCodeType2sRadGrid.MasterTableView.SortExpressions.Count > 0 ? $"{d[StatisticalCodeType2sRadGrid.MasterTableView.SortExpressions[0].FieldName]}{(StatisticalCodeType2sRadGrid.MasterTableView.SortExpressions[0].SortOrder == GridSortOrder.Descending ? "/sort.descending" : "")}" : null, load: true))
