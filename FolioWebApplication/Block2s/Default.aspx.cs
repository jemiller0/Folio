...
namespace FolioWebApplication.Block2s
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Block2sRadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            Block2sRadGrid.DataSource = folioServiceContext.Block2s(where, Block2sRadGrid.MasterTableView.SortExpressions.Count > 0 ? $"{d[Block2sRadGrid.MasterTableView.SortExpressions[0].FieldName]}{(Block2sRadGrid.MasterTableView.SortExpressions[0].SortOrder == GridSortOrder.Descending ? "/sort.descending" : "")}" : null, Block2sRadGrid.PageSize * Block2sRadGrid.CurrentPageIndex, Block2sRadGrid.PageSize, true);
            Block2sRadGrid.VirtualItemCount = folioServiceContext.CountBlock2s(where);
        ...
        protected void ExportLinkButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (var b2 in folioServiceContext.Block2s(where, Block2sRadGrid.MasterTableView.SortExpressions.Count > 0 ? $"{d[Block2sRadGrid.MasterTableView.SortExpressions[0].FieldName]}{(Block2sRadGrid.MasterTableView.SortExpressions[0].SortOrder == GridSortOrder.Descending ? "/sort.descending" : "")}" : null, load: true))
