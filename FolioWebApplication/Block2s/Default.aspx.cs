...
namespace FolioWebApplication.Block2s
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void ExportLinkButton_Click(object sender, EventArgs e)
        {
            ...
            var d = new Dictionary<string, string>() { { "Id", "id" }, { "Type", "type" }, { "Desc", "desc" }, { "StaffInformation", "staffInformation" }, { "PatronMessage", "patronMessage" }, { "ExpirationDate", "expirationDate" }, { "Borrowing", "borrowing" }, { "Renewals", "renewals" }, { "Requests", "requests" }, { "UserId", "userId" }, { "CreationTime", "metadata.createdDate" }, { "CreationUserId", "metadata.createdByUserId" }, { "LastWriteTime", "metadata.updatedDate" }, { "LastWriteUserId", "metadata.updatedByUserId" } };
            Response.Write("Id\tType\tDesc\tStaffInformation\tPatronMessage\tExpirationDate\tBorrowing\tRenewals\tRequests\tUser\tUserId\tCreationTime\tCreationUser\tCreationUserId\tLastWriteTime\tLastWriteUser\tLastWriteUserId\r\n");
