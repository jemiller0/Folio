...
namespace FolioWebApplication.OrderItem2s
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        protected void OrderItemFiscalYearDistributionsRadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            if (Session["OrderItemFiscalYearDistributionsPermission"] == null) return;
            var id = (Guid?)OrderItem2FormView.DataKey.Value;
            if (id == null) return;
            var l = folioServiceContext.FindOrderItem2(id, true).OrderItemFiscalYearDistributions ?? new OrderItemFiscalYearDistribution[] { };
            OrderItemFiscalYearDistributionsRadGrid.DataSource = l;
            OrderItemFiscalYearDistributionsRadGrid.AllowFilteringByColumn = l.Count() > 10;
            OrderItemFiscalYearDistributionsPanel.Visible = OrderItem2FormView.DataKey.Value != null && ((string)Session["OrderItemFiscalYearDistributionsPermission"] == "Edit" || Session["OrderItemFiscalYearDistributionsPermission"] != null && l.Any());
        }
        ...
        protected void Receiving2sRadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var where = Global.Trim(string.Join(" and ", new string[]
            {
                ...
                Global.GetCqlFilter(Receiving2sRadGrid, "SequenceNumber", "sequenceNumber"),
