    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void OrderItem2sRadGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            var where = Global.Trim(string.Join(" and ", new string[]
            {
                ...
                Global.GetCqlFilter(OrderItem2sRadGrid, "LastExportTransmissionMethod", "lastExport.transmissionMethod"),
                ...
                Global.GetCqlFilter(OrderItem2sRadGrid, "MultiYearPayment", "multiYearPayment"),
                Global.GetCqlFilter(OrderItem2sRadGrid, "PaymentTermsTotalPrice", "paymentTerms.totalPrice"),
                Global.GetCqlFilter(OrderItem2sRadGrid, "PaymentTermsPrepaymentTerm", "paymentTerms.prepaymentTerm"),
                Global.GetCqlFilter(OrderItem2sRadGrid, "PaymentTermsStartingFiscalYear.Name", "paymentTerms.startingFiscalYearId", "name", folioServiceContext.FolioServiceClient.FiscalYears),
        ...
        protected void ExportLinkButton_Click(object sender, EventArgs e)
        {
            ...
            Response.Write("Id\tEdition\tCheckinItems\tAgreement\tAgreementId\tAcquisitionMethod\tAcquisitionMethodId\tAutomaticExport\tCancellationRestriction\tCancellationRestrictionNote\tClaimingActive\tClaimingInterval\tCollection\tPhysicalUnitListPrice\tElectronicUnitListPrice\tCurrency\tAdditionalCost\tDiscount\tDiscountType\tExchangeRate\tPhysicalQuantity\tElectronicQuantity\tEstimatedPrice\tFiscalYearRolloverAdjustmentAmount\tInternalNote\tReceivingNote\tDetailsIsAcknowledged\tDetailsIsBinderyActive\tSubscriptionFrom\tSubscriptionInterval\tSubscriptionTo\tDonor\tEresourceActivated\tEresourceActivationDue\tEresourceCreateInventory\tEresourceTrial\tEresourceExpectedActivationDate\tEresourceUserLimit\tEresourceAccessProvider\tEresourceAccessProviderId\tEresourceLicenseCode\tEresourceLicenseDescription\tEresourceLicenseReference\tEresourceMaterialType\tEresourceMaterialTypeId\tEresourceResourceUrl\tInstance\tInstanceId\tIsPackage\tLastEdiExportDate\tLastExportTransmissionMethod\tOrderFormat\tPackageOrderItem\tPackageOrderItemId\tPaymentStatus\tPhysicalCreateInventory\tPhysicalMaterialType\tPhysicalMaterialTypeId\tPhysicalMaterialSupplier\tPhysicalMaterialSupplierId\tPhysicalExpectedReceiptDate\tPhysicalReceiptDue\tDescription\tNumber\tPublicationYear\tPublisher\tOrder\tOrderId\tReceiptDate\tReceiptStatus\tRenewalNote\tRequester\tRush\tSelector\tSource\tTitleOrPackage\tVendorInstructions\tVendorNote\tVendorCustomerId\tSuppressInstanceFromDiscovery\tMultiYearPayment\tPaymentTermsTotalPrice\tPaymentTermsPrepaymentTerm\tPaymentTermsStartingFiscalYear\tPaymentTermsStartingFiscalYearId\tCreationTime\tCreationUser\tCreationUserId\tLastWriteTime\tLastWriteUser\tLastWriteUserId\r\n");
            var d = new Dictionary<string, string>() { { "Id", "id" }, { "Edition", "edition" }, { "CheckinItems", "checkinItems" }, { "AgreementId", "agreementId" }, { "AcquisitionMethodId", "acquisitionMethod" }, { "AutomaticExport", "automaticExport" }, { "CancellationRestriction", "cancellationRestriction" }, { "CancellationRestrictionNote", "cancellationRestrictionNote" }, { "ClaimingActive", "claimingActive" }, { "ClaimingInterval", "claimingInterval" }, { "Collection", "collection" }, { "PhysicalUnitListPrice", "cost.listUnitPrice" }, { "ElectronicUnitListPrice", "cost.listUnitPriceElectronic" }, { "Currency", "cost.currency" }, { "AdditionalCost", "cost.additionalCost" }, { "Discount", "cost.discount" }, { "DiscountType", "cost.discountType" }, { "ExchangeRate", "cost.exchangeRate" }, { "PhysicalQuantity", "cost.quantityPhysical" }, { "ElectronicQuantity", "cost.quantityElectronic" }, { "EstimatedPrice", "cost.poLineEstimatedPrice" }, { "FiscalYearRolloverAdjustmentAmount", "cost.fyroAdjustmentAmount" }, { "InternalNote", "description" }, { "ReceivingNote", "details.receivingNote" }, { "DetailsIsAcknowledged", "details.isAcknowledged" }, { "DetailsIsBinderyActive", "details.isBinderyActive" }, { "SubscriptionFrom", "details.subscriptionFrom" }, { "SubscriptionInterval", "details.subscriptionInterval" }, { "SubscriptionTo", "details.subscriptionTo" }, { "Donor", "donor" }, { "EresourceActivated", "eresource.activated" }, { "EresourceActivationDue", "eresource.activationDue" }, { "EresourceCreateInventory", "eresource.createInventory" }, { "EresourceTrial", "eresource.trial" }, { "EresourceExpectedActivationDate", "eresource.expectedActivation" }, { "EresourceUserLimit", "eresource.userLimit" }, { "EresourceAccessProviderId", "eresource.accessProvider" }, { "EresourceLicenseCode", "eresource.license.code" }, { "EresourceLicenseDescription", "eresource.license.description" }, { "EresourceLicenseReference", "eresource.license.reference" }, { "EresourceMaterialTypeId", "eresource.materialType" }, { "EresourceResourceUrl", "eresource.resourceUrl" }, { "InstanceId", "instanceId" }, { "IsPackage", "isPackage" }, { "LastEdiExportDate", "lastEDIExportDate" }, { "LastExportTransmissionMethod", "lastExport.transmissionMethod" }, { "OrderFormat", "orderFormat" }, { "PackageOrderItemId", "packagePoLineId" }, { "PaymentStatus", "paymentStatus" }, { "PhysicalCreateInventory", "physical.createInventory" }, { "PhysicalMaterialTypeId", "physical.materialType" }, { "PhysicalMaterialSupplierId", "physical.materialSupplier" }, { "PhysicalExpectedReceiptDate", "physical.expectedReceiptDate" }, { "PhysicalReceiptDue", "physical.receiptDue" }, { "Description", "poLineDescription" }, { "Number", "poLineNumber" }, { "PublicationYear", "publicationDate" }, { "Publisher", "publisher" }, { "OrderId", "purchaseOrderId" }, { "ReceiptDate", "receiptDate" }, { "ReceiptStatus", "receiptStatus" }, { "RenewalNote", "renewalNote" }, { "Requester", "requester" }, { "Rush", "rush" }, { "Selector", "selector" }, { "Source", "source" }, { "TitleOrPackage", "titleOrPackage" }, { "VendorInstructions", "vendorDetail.instructions" }, { "VendorNote", "vendorDetail.noteFromVendor" }, { "VendorCustomerId", "vendorDetail.vendorAccount" }, { "SuppressInstanceFromDiscovery", "suppressInstanceFromDiscovery" }, { "MultiYearPayment", "multiYearPayment" }, { "PaymentTermsTotalPrice", "paymentTerms.totalPrice" }, { "PaymentTermsPrepaymentTerm", "paymentTerms.prepaymentTerm" }, { "PaymentTermsStartingFiscalYearId", "paymentTerms.startingFiscalYearId" }, { "CreationTime", "metadata.createdDate" }, { "CreationUserId", "metadata.createdByUserId" }, { "LastWriteTime", "metadata.updatedDate" }, { "LastWriteUserId", "metadata.updatedByUserId" } };
            var where = Global.Trim(string.Join(" and ", new string[]
            {
                Global.GetCqlFilter(OrderItem2sRadGrid, "Id", "id"),
