<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FolioWebApplication.StaffSlip2s.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="StaffSlip2Panel" runat="server">
        <fieldset>
            <legend>
                <asp:HyperLink ID="StaffSlip2HyperLink" runat="server" Text="Staff Slip" NavigateUrl="Default.aspx" /></legend>
            <asp:FormView ID="StaffSlip2FormView" runat="server" DataKeyNames="Id" DefaultMode="ReadOnly" RenderOuterTable="false" OnDataBinding="StaffSlip2FormView_DataBinding">
                <ItemTemplate>
                    <asp:Panel ID="ViewStaffSlip2Panel" runat="server">
                        <table>
                            ...
                            <tr runat="server" visible='<%# Eval("Template") != null %>'>
                                ...
                                <td>
                                    <asp:Literal ID="TemplateLiteral" runat="server" Text='<%#: Eval("Template") %>' />
                                </td>
                            </tr>
