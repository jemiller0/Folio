<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FolioWebApplication.TransferAccount2s.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="TransferAccount2Panel" runat="server">
        <fieldset>
            <legend>
                <asp:HyperLink ID="TransferAccount2HyperLink" runat="server" Text="Transfer Account" NavigateUrl="Default.aspx" /></legend>
            <asp:FormView ID="TransferAccount2FormView" runat="server" DataKeyNames="Id" DefaultMode="ReadOnly" RenderOuterTable="false" OnDataBinding="TransferAccount2FormView_DataBinding">
                <ItemTemplate>
                    <asp:Panel ID="ViewTransferAccount2Panel" runat="server">
                        <table>
