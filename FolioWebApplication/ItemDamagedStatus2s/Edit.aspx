<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FolioWebApplication.ItemDamagedStatus2s.Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="ItemDamagedStatus2Panel" runat="server">
        <fieldset>
            <legend>
                <asp:HyperLink ID="ItemDamagedStatus2HyperLink" runat="server" Text="Item Damaged Status" NavigateUrl="Default.aspx" /></legend>
            <asp:FormView ID="ItemDamagedStatus2FormView" runat="server" DataKeyNames="Id" DefaultMode="ReadOnly" RenderOuterTable="false" OnDataBinding="ItemDamagedStatus2FormView_DataBinding">
                <ItemTemplate>
                    <asp:Panel ID="ViewItemDamagedStatus2Panel" runat="server">
                        <table>
    ...
    <asp:Panel ID="Item2sPanel" runat="server" Visible='<%# (string)Session["Item2sPermission"] != null && ItemDamagedStatus2FormView.DataKey.Value != null %>'>
        <fieldset>
            <legend>
