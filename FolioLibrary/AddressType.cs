...
{
    [Table("addresstype", Schema = "diku_mod_users")]
    public partial class AddressType
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.AddressType.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(AddressType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
