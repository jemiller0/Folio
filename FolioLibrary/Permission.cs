...
namespace FolioLibrary
{
    ...
    public partial class Permission
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Permission.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Permission), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
