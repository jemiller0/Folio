...
{
    [Table("instance_date_type", Schema = "uchicago_mod_inventory_storage")]
    public partial class DateType
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(DateType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static DateType FromJObject(JObject jObject) => jObject != null ? new DateType
        {
