...
{
    // uc.contact_urls -> uchicago_mod_organizations_storage.contacts
    // ContactUrl -> Contact
    ...
    public partial class ContactUrl
    {
        ...
        public static ContactUrl FromJObject(JObject jObject) => jObject != null ? new ContactUrl
        {
            ...
            ContactUrlCategories = jObject.SelectToken("categories")?.Select(jt => ContactUrlCategory.FromJObject((JValue)jt)).ToArray()
        } : null;
