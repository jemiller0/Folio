...
{
    // uc.item_note_types -> uchicago_mod_inventory_storage.item_note_type
    // ItemNoteType2 -> ItemNoteType
    [DisplayColumn(nameof(Name)), DisplayName("Item Note Types"), JsonConverter(typeof(JsonPathJsonConverter<ItemNoteType2>)), JsonObject(MemberSerialization = MemberSerialization.OptIn), Table("item_note_types", Schema = "uc")]
    public partial class ItemNoteType2
    {
        public static ValidationResult ValidateContent(string value)
        {
            using (var sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.ItemNoteType.json")))
            {
        ...
        [Column("source"), Display(Order = 3), JsonProperty("source"), Required, StringLength(1024)]
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("ItemNoteType2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("ItemNoteType2s1")]
        ...
        [Column("content"), CustomValidation(typeof(ItemNoteType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 12), Editable(false)]
        public virtual string Content { get; set; }

        [Display(Name = "Item Notes", Order = 13)]
        ...
        public static ItemNoteType2 FromJObject(JObject jObject) => jObject != null ? new ItemNoteType2
        {
