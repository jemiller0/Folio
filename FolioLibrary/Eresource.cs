...
{
    [Table("eresource", Schema = "diku_mod_orders_storage")]
    public partial class Eresource
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Eresource.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Eresource), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
