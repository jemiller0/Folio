...
{
    [Table("transfers", Schema = "diku_mod_feesfines")]
    public partial class Transfer
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Transfer.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Transfer), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
