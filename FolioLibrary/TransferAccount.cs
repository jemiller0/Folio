...
{
    [Table("transfers", Schema = "uchicago_mod_feesfines")]
    public partial class TransferAccount
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(TransferAccount), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static TransferAccount FromJObject(JObject jObject) => jObject != null ? new TransferAccount
        {
