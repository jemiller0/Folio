...
{
    // uc.contact_addresses -> diku_mod_organizations_storage.contacts
    ...
    public partial class ContactAddress
    {
        ...
        public static ContactAddress FromJObject(JObject jObject) => jObject != null ? new ContactAddress
        {
            ...
            ContactAddressCategories = jObject.SelectToken("categories")?.Where(jt => jt.HasValues).Select(jt => ContactAddressCategory.FromJObject((JValue)jt)).ToArray()
        } : null;
