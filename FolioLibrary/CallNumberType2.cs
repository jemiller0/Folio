...
namespace FolioLibrary
{
    ...
    public partial class CallNumberType2
    {
        ...
        {
            using (var sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.CallNumberType.json")))
            {
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("CallNumberType2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("CallNumberType2s1")]
        ...
        [Column("content"), CustomValidation(typeof(CallNumberType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 12), Editable(false)]
        ...
        public static CallNumberType2 FromJObject(JObject jObject) => jObject != null ? new CallNumberType2
        {
