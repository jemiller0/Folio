...
namespace FolioLibrary
{
    ...
    public partial class WaiveReason2
    {
        ...
        {
            using (var sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.WaiveReason.json")))
            {
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("WaiveReason2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("WaiveReason2s1")]
        ...
        [Column("content"), CustomValidation(typeof(WaiveReason), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 14), Editable(false)]
        ...
        public static WaiveReason2 FromJObject(JObject jObject) => jObject != null ? new WaiveReason2
        {
