...
{
    [Table("vendor_type", Schema = "diku_mod_vendors")]
    public partial class VendorType
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.VendorType.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(VendorType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
