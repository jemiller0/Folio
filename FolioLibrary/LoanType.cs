...
{
    [Table("loan_type", Schema = "uchicago_mod_inventory_storage")]
    public partial class LoanType
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(LoanType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static LoanType FromJObject(JObject jObject) => jObject != null ? new LoanType
        {
