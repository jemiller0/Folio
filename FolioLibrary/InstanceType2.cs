...
{
    // uc.instance_types -> uchicago_mod_inventory_storage.instance_type
    // InstanceType2 -> InstanceType
    [DisplayColumn(nameof(Name)), DisplayName("Instance Types"), JsonConverter(typeof(JsonPathJsonConverter<InstanceType2>)), JsonObject(MemberSerialization = MemberSerialization.OptIn), Table("instance_types", Schema = "uc")]
    public partial class InstanceType2
    {
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("InstanceType2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("InstanceType2s1")]
        ...
        [Column("content"), CustomValidation(typeof(InstanceType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 12), Editable(false)]
        ...
        public static InstanceType2 FromJObject(JObject jObject) => jObject != null ? new InstanceType2
        {
