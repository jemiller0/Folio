...
{
    [Table("account", Schema = "diku_mod_vendors")]
    public partial class Account2
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Account2.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Account2), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
