...
namespace FolioLibrary
{
    ...
    public partial class Contact2
    {
        ...
        [Column("prefix"), Display(Order = 4), JsonProperty("prefix"), StringLength(1024)]
        public virtual string Prefix { get; set; }

        [Column("first_name"), Display(Name = "First Name", Order = 5), JsonProperty("firstName"), Required, StringLength(1024)]
        public virtual string FirstName { get; set; }

        [Column("last_name"), Display(Name = "Last Name", Order = 6), JsonProperty("lastName"), Required, StringLength(1024)]
        public virtual string LastName { get; set; }

        [Column("language"), Display(Order = 7), JsonProperty("language"), StringLength(1024)]
        public virtual string Language { get; set; }

        [Column("notes"), Display(Order = 8), JsonProperty("notes"), StringLength(1024)]
        public virtual string Notes { get; set; }

        [Column("inactive"), Display(Order = 9), JsonProperty("inactive")]
        ...
        [Display(Name = "Creation User", Order = 11), InverseProperty("Contact2s")]
        ...
        [Display(Name = "Last Write User", Order = 15), InverseProperty("Contact2s1")]
        ...
        [Column("content"), CustomValidation(typeof(Contact), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 18), Editable(false)]
