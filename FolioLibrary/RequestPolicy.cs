...
{
    [Table("request_policy", Schema = "diku_mod_circulation_storage")]
    public partial class RequestPolicy
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.RequestPolicy.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(RequestPolicy), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
