...
{
    [Table("refunds", Schema = "diku_mod_feesfines")]
    public partial class Refund
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Refund.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Refund), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
