...
{
    // uc.organizations -> diku_mod_organizations_storage.organizations
    ...
    public partial class Organization2
    {
        ...
        [Column("erp_code"), Display(Name = "ERP Code", Order = 8), JsonProperty("erpCode"), StringLength(1024)]
        ...
        public static Organization2 FromJObject(JObject jObject) => jObject != null ? new Organization2
        {
            ...
            ErpCode = (string)jObject.SelectToken("erpCode"),
            ...
            EdiJobSchedulingDate = ((DateTime?)jObject.SelectToken("edi.ediJob.schedulingDate"))?.ToLocalTime(),
            ...
            Currencies = jObject.SelectToken("vendorCurrencies")?.Where(jt => jt.HasValues).Select(jt => Currency.FromJObject((JValue)jt)).ToArray(),
            ...
            OrganizationAcquisitionsUnits = jObject.SelectToken("acqUnitIds")?.Where(jt => jt.HasValues).Select(jt => OrganizationAcquisitionsUnit.FromJObject((JValue)jt)).ToArray(),
            ...
            OrganizationContacts = jObject.SelectToken("contacts")?.Where(jt => jt.HasValues).Select(jt => OrganizationContact.FromJObject((JValue)jt)).ToArray(),
            ...
            OrganizationInterfaces = jObject.SelectToken("interfaces")?.Where(jt => jt.HasValues).Select(jt => OrganizationInterface.FromJObject((JValue)jt)).ToArray(),
            ...
            OrganizationTags = jObject.SelectToken("tags.tagList")?.Where(jt => jt.HasValues).Select(jt => OrganizationTag.FromJObject((JValue)jt)).ToArray(),
        ...
        public JObject ToJObject() => new JObject(
            ...
            new JProperty("edi", new JObject(
                ...
                new JProperty("ediJob", new JObject(
                    ...
                    new JProperty("schedulingDate", EdiJobSchedulingDate?.ToUniversalTime()),
