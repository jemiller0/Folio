...
{
    [Table("vendor", Schema = "diku_mod_vendors")]
    public partial class Vendor
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Vendor.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Vendor), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
