...
{
    // uc.contact_phone_numbers -> diku_mod_organizations_storage.contacts
    ...
    public partial class ContactPhoneNumber
    {
        ...
        public static ContactPhoneNumber FromJObject(JObject jObject) => jObject != null ? new ContactPhoneNumber
        {
            ...
            ContactPhoneNumberCategories = jObject.SelectToken("categories")?.Where(jt => jt.HasValues).Select(jt => ContactPhoneNumberCategory.FromJObject((JValue)jt)).ToArray()
        } : null;
