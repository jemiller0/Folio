...
{
    [Table("item_damaged_status", Schema = "uchicago_mod_inventory_storage")]
    public partial class ItemDamagedStatus
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(ItemDamagedStatus), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static ItemDamagedStatus FromJObject(JObject jObject) => jObject != null ? new ItemDamagedStatus
        {
