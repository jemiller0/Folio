...
namespace FolioLibrary
{
    ...
    public partial class NatureOfContentTerm
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(NatureOfContentTerm), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static NatureOfContentTerm FromJObject(JObject jObject) => jObject != null ? new NatureOfContentTerm
        {
