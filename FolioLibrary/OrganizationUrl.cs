...
{
    // uc.organization_urls -> uchicago_mod_organizations_storage.organizations
    ...
    public partial class OrganizationUrl
    {
        ...
        public static OrganizationUrl FromJObject(JObject jObject) => jObject != null ? new OrganizationUrl
        {
            ...
            OrganizationUrlCategories = jObject.SelectToken("categories")?.Select(jt => OrganizationUrlCategory.FromJObject((JValue)jt)).ToArray()
        } : null;
