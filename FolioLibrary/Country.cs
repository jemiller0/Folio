...
namespace FolioLibrary
{
    ...
    {
        [Column("alpha2_code"), Display(Name = "Alpha 2 Code", Order = 1), Key, Required, StringLength(2)]
        public virtual string Alpha2Code { get; set; }

        [Column("alpha3_code"), Display(Name = "Alpha 3 Code", Order = 2), Required, StringLength(3)]
