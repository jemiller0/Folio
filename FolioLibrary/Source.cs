...
{
    [Table("holdings_records_source", Schema = "uchicago_mod_inventory_storage")]
    public partial class Source
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(Source), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static Source FromJObject(JObject jObject) => jObject != null ? new Source
        {
