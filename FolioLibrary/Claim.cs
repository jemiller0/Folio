...
{
    [Table("claim", Schema = "diku_mod_orders_storage")]
    public partial class Claim
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Claim.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Claim), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
