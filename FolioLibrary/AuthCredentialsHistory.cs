...
namespace FolioLibrary
{
    ...
    public partial class AuthCredentialsHistory
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.AuthCredentialsHistory.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(AuthCredentialsHistory), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
