...
{
    // uc.rollover_progresses -> uchicago_mod_finance_storage.ledger_fiscal_year_rollover_progress
    // RolloverProgress2 -> RolloverProgress
    [DisplayColumn(nameof(Id)), DisplayName("Rollover Progresses"), JsonConverter(typeof(JsonPathJsonConverter<RolloverProgress2>)), JsonObject(MemberSerialization = MemberSerialization.OptIn), Table("rollover_progresses", Schema = "uc")]
    public partial class RolloverProgress2
    {
        public static ValidationResult ValidateContent(string value)
        {
            using (var sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.RolloverProgress.json")))
            {
        ...
        [Display(Name = "Creation User", Order = 9), InverseProperty("RolloverProgress2s")]
        ...
        [Display(Name = "Last Write User", Order = 13), InverseProperty("RolloverProgress2s1")]
