...
{
    [Table("classification_type", Schema = "uchicago_mod_inventory_storage")]
    public partial class ClassificationType
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(ClassificationType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static ClassificationType FromJObject(JObject jObject) => jObject != null ? new ClassificationType
        {
