...
{
    [Table("phone_number", Schema = "diku_mod_vendors")]
    public partial class PhoneNumber
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.PhoneNumber.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(PhoneNumber), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
