...
{
    [Table("address", Schema = "diku_mod_vendors")]
    public partial class Address
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Address.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Address), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
