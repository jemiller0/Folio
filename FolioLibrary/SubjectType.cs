...
{
    [Table("subject_type", Schema = "uchicago_mod_inventory_storage")]
    public partial class SubjectType
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(SubjectType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static SubjectType FromJObject(JObject jObject) => jObject != null ? new SubjectType
        {
