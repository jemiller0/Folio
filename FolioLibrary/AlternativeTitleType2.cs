...
namespace FolioLibrary
{
    ...
    public partial class AlternativeTitleType2
    {
        ...
        {
            using (var sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.AlternativeTitleType.json")))
            {
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("AlternativeTitleType2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("AlternativeTitleType2s1")]
        ...
        [Column("content"), CustomValidation(typeof(AlternativeTitleType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 12), Editable(false)]
        public virtual string Content { get; set; }

        [Display(Name = "Alternative Titles", Order = 13)]
        ...
        public static AlternativeTitleType2 FromJObject(JObject jObject) => jObject != null ? new AlternativeTitleType2
        {
