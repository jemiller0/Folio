...
{
    [Table("comments", Schema = "diku_mod_feesfines")]
    public partial class Comment
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Comment.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Comment), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
