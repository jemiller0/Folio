...
{
    [Table("permissions_users", Schema = "diku_mod_permissions")]
    public partial class PermissionsUser
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.PermissionsUser.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(PermissionsUser), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
