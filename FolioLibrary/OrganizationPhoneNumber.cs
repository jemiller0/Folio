...
{
    // uc.organization_phone_numbers -> uchicago_mod_organizations_storage.organizations
    ...
    public partial class OrganizationPhoneNumber
    {
        ...
        public static OrganizationPhoneNumber FromJObject(JObject jObject) => jObject != null ? new OrganizationPhoneNumber
        {
            ...
            OrganizationPhoneNumberCategories = jObject.SelectToken("categories")?.Select(jt => OrganizationPhoneNumberCategory.FromJObject((JValue)jt)).ToArray()
        } : null;
