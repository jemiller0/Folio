...
{
    [Table("agreement", Schema = "diku_mod_vendors")]
    public partial class Agreement
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Agreement.json")))
