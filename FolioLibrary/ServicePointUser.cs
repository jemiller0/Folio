...
{
    [Table("service_point_user", Schema = "diku_mod_inventory_storage")]
    public partial class ServicePointUser
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.ServicePointUser.json")))
