...
namespace FolioLibrary
{
    ...
    public partial class CancellationReason
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.CancellationReason.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(CancellationReason), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
