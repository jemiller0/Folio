...
{
    [Table("organizations", Schema = "uchicago_mod_organizations_storage")]
    public partial class Organization
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(Organization), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static Organization FromJObject(JObject jObject) => jObject != null ? new Organization
        {
