...
namespace FolioLibrary
{
    ...
    public partial class ItemDamagedStatus2
    {
        ...
        {
            using (var sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.ItemDamagedStatus.json")))
            {
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("ItemDamagedStatus2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("ItemDamagedStatus2s1")]
        ...
        [Column("content"), CustomValidation(typeof(ItemDamagedStatus), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 12), Editable(false)]
        public virtual string Content { get; set; }

        [Display(Name = "Items", Order = 13)]
        ...
        public static ItemDamagedStatus2 FromJObject(JObject jObject) => jObject != null ? new ItemDamagedStatus2
        {
