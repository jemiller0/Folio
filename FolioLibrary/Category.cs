...
{
    [Table("categories", Schema = "uchicago_mod_organizations_storage")]
    public partial class Category
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(Category), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static Category FromJObject(JObject jObject) => jObject != null ? new Category
        {
