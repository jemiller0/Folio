...
{
    [Table("identifier_type", Schema = "diku_mod_inventory_storage")]
    public partial class IdType
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.IdType.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(IdType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
