...
{
    [Table("lost_item_fee_policy", Schema = "uchicago_mod_feesfines")]
    public partial class LostItemFeePolicy
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(LostItemFeePolicy), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static LostItemFeePolicy FromJObject(JObject jObject) => jObject != null ? new LostItemFeePolicy
        {
