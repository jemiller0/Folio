...
{
    [Table("details", Schema = "diku_mod_orders_storage")]
    public partial class Detail
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Detail.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Detail), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
