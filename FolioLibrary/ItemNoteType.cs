...
{
    [Table("item_note_type", Schema = "uchicago_mod_inventory_storage")]
    public partial class ItemNoteType
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(ItemNoteType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static ItemNoteType FromJObject(JObject jObject) => jObject != null ? new ItemNoteType
        {
