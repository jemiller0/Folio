...
{
    // uc.organization_addresses -> uchicago_mod_organizations_storage.organizations
    ...
    public partial class OrganizationAddress
    {
        ...
        public override string ToString() => $"{{ {nameof(Id)} = {Id}, {nameof(OrganizationId)} = {OrganizationId}, {nameof(Id2)} = {Id2}, {nameof(StreetAddress1)} = {StreetAddress1}, {nameof(StreetAddress2)} = {StreetAddress2}, {nameof(City)} = {City}, {nameof(State)} = {State}, {nameof(PostalCode)} = {PostalCode}, {nameof(CountryCode)} = {CountryCode}, {nameof(IsPrimary)} = {IsPrimary}, {nameof(Language)} = {Language}, {nameof(CreationTime)} = {CreationTime}, {nameof(CreationUserId)} = {CreationUserId}, {nameof(CreationUserUsername)} = {CreationUserUsername}, {nameof(LastWriteTime)} = {LastWriteTime}, {nameof(LastWriteUserId)} = {LastWriteUserId}, {nameof(LastWriteUserUsername)} = {LastWriteUserUsername}, {nameof(OrganizationAddressCategories)} = {(OrganizationAddressCategories != null ? $"{{ {string.Join(", ", OrganizationAddressCategories)} }}" : "")} }}";
        ...
        public static OrganizationAddress FromJObject(JObject jObject) => jObject != null ? new OrganizationAddress
        {
            ...
            OrganizationAddressCategories = jObject.SelectToken("categories")?.Select(jt => OrganizationAddressCategory.FromJObject((JValue)jt)).ToArray()
        } : null;
