...
{
    [Table("authority_source_file", Schema = "uchicago_mod_inventory_storage")]
    public partial class AuthoritySourceFile
    {
        ...
        public static AuthoritySourceFile FromJObject(JValue jObject) => jObject != null ? new AuthoritySourceFile
        {
