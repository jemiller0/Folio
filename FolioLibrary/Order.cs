...
{
    [Table("purchase_order", Schema = "diku_mod_orders_storage")]
    public partial class Order
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Order.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Order), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
