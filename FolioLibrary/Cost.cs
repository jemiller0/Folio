...
{
    [Table("cost", Schema = "diku_mod_orders_storage")]
    public partial class Cost
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Cost.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Cost), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
