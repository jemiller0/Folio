...
{
    [Table("holdings_note_type", Schema = "uchicago_mod_inventory_storage")]
    public partial class HoldingNoteType
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(HoldingNoteType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static HoldingNoteType FromJObject(JObject jObject) => jObject != null ? new HoldingNoteType
        {
