...
{
    [Table("alias", Schema = "diku_mod_vendors")]
    public partial class Alias
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Alias.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Alias), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
