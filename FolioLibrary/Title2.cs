...
namespace FolioLibrary
{
    ...
    public partial class Title2
    {
        ...
        public static Title2 FromJObject(JObject jObject) => jObject != null ? new Title2
        {
            ...
            ExpectedReceiptDate = ((DateTime?)jObject.SelectToken("expectedReceiptDate"))?.ToLocalTime(),
            ...
            SubscriptionFrom = ((DateTime?)jObject.SelectToken("subscriptionFrom"))?.ToLocalTime(),
            SubscriptionTo = ((DateTime?)jObject.SelectToken("subscriptionTo"))?.ToLocalTime(),
        ...
        public JObject ToJObject() => new JObject(
            new JProperty("id", Id),
            new JProperty("expectedReceiptDate", ExpectedReceiptDate?.ToUniversalTime()),
