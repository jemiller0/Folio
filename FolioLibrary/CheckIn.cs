...
{
    [Table("check_in", Schema = "uchicago_mod_circulation_storage")]
    public partial class CheckIn
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(CheckIn), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static CheckIn FromJObject(JObject jObject) => jObject != null ? new CheckIn
        {
