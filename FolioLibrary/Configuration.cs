...
{
    [Table("config_data", Schema = "uchicago_mod_configuration")]
    public partial class Configuration
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(Configuration), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static Configuration FromJObject(JObject jObject) => jObject != null ? new Configuration
        {
