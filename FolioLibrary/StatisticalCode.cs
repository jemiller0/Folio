...
{
    [Table("statistical_code", Schema = "uchicago_mod_inventory_storage")]
    public partial class StatisticalCode
    {
        ...
        [Column("statisticalcodetypeid"), Display(Name = "Statistical Code Type", Order = 6), ForeignKey("StatisticalCodeType")]
        ...
        public static StatisticalCode FromJObject(JObject jObject) => jObject != null ? new StatisticalCode
        {
