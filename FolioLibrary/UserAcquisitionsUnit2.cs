...
namespace FolioLibrary
{
    ...
    public partial class UserAcquisitionsUnit2
    {
        ...
        [Display(Order = 2), InverseProperty("UserAcquisitionsUnit2s2")]
        ...
        [Column("acquisitions_unit_id"), Display(Name = "Acquisitions Unit", Order = 5), JsonProperty("acquisitionsUnitId"), Required]
        ...
        [Display(Name = "Creation User", Order = 7), InverseProperty("UserAcquisitionsUnit2s")]
        ...
        [Display(Name = "Last Write User", Order = 11), InverseProperty("UserAcquisitionsUnit2s1")]
        ...
        [Column("content"), CustomValidation(typeof(UserAcquisitionsUnit), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 14), Editable(false)]
        public virtual string Content { get; set; }

        public override string ToString() => $"{{ {nameof(Id)} = {Id}, {nameof(UserId)} = {UserId}, {nameof(AcquisitionsUnitId)} = {AcquisitionsUnitId}, {nameof(CreationTime)} = {CreationTime}, {nameof(CreationUserId)} = {CreationUserId}, {nameof(CreationUserUsername)} = {CreationUserUsername}, {nameof(LastWriteTime)} = {LastWriteTime}, {nameof(LastWriteUserId)} = {LastWriteUserId}, {nameof(LastWriteUserUsername)} = {LastWriteUserUsername}, {nameof(Content)} = {Content} }}";

        public static UserAcquisitionsUnit2 FromJObject(JObject jObject) => jObject != null ? new UserAcquisitionsUnit2
        {
        ...
        public JObject ToJObject() => new JObject(
            ...
            new JProperty("acquisitionsUnitId", AcquisitionsUnitId),
