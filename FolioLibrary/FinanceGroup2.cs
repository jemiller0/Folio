...
namespace FolioLibrary
{
    ...
    public partial class FinanceGroup2
    {
        ...
        [Column("name"), Display(Order = 5), JsonProperty("name"), Required, StringLength(1024)]
        public virtual string Name { get; set; }

        [Column("status"), Display(Order = 6), JsonProperty("status"), RegularExpression(@"^(Active|Frozen|Inactive)$"), Required, StringLength(1024)]
        ...
        [Display(Name = "Creation User", Order = 8), InverseProperty("FinanceGroup2s")]
        ...
        [Display(Name = "Last Write User", Order = 12), InverseProperty("FinanceGroup2s1")]
        ...
        [Column("content"), CustomValidation(typeof(FinanceGroup), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 15), Editable(false)]
        public virtual string Content { get; set; }

        [Display(Name = "Budget Groups", Order = 16)]
        public virtual ICollection<BudgetGroup2> BudgetGroup2s { get; set; }

        [Display(Name = "Finance Group Acquisitions Units", Order = 17), JsonConverter(typeof(ArrayJsonConverter<List<FinanceGroupAcquisitionsUnit>, FinanceGroupAcquisitionsUnit>), "AcquisitionsUnitId"), JsonProperty("acqUnitIds")]
        ...
        public static FinanceGroup2 FromJObject(JObject jObject) => jObject != null ? new FinanceGroup2
        {
            ...
            FinanceGroupAcquisitionsUnits = jObject.SelectToken("acqUnitIds")?.Select(jt => FinanceGroupAcquisitionsUnit.FromJObject((JValue)jt)).ToArray()
        } : null;
