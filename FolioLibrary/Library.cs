...
{
    [Table("loclibrary", Schema = "diku_mod_inventory_storage")]
    public partial class Library
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Library.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Library), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        [Column("campusid"), Display(Name = "Campus", Order = 6), Editable(false), ForeignKey("Campus")]
