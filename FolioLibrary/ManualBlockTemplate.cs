...
namespace FolioLibrary
{
    ...
    public partial class ManualBlockTemplate
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(ManualBlockTemplate), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static ManualBlockTemplate FromJObject(JObject jObject) => jObject != null ? new ManualBlockTemplate
        {
