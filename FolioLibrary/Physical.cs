...
{
    [Table("physical", Schema = "diku_mod_orders_storage")]
    public partial class Physical
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Physical.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Physical), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
