...
namespace FolioLibrary
{
    ...
    public partial class ElectronicAccessRelationship2
    {
        ...
        [Display(Name = "Creation User", Order = 4), InverseProperty("ElectronicAccessRelationship2s")]
        ...
        [Display(Name = "Last Write User", Order = 8), InverseProperty("ElectronicAccessRelationship2s1")]
