...
{
    // uc.ill_policies -> uchicago_mod_inventory_storage.ill_policy
    ...
    public partial class IllPolicy2
    {
        ...
        {
            using (var sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.IllPolicy.json")))
            {
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("IllPolicy2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("IllPolicy2s1")]
        ...
        [Column("content"), CustomValidation(typeof(IllPolicy), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 12), Editable(false)]
        ...
        public static IllPolicy2 FromJObject(JObject jObject) => jObject != null ? new IllPolicy2
        {
