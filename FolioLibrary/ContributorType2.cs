...
namespace FolioLibrary
{
    ...
    public partial class ContributorType2
    {
        ...
        {
            using (var sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.ContributorType.json")))
            {
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("ContributorType2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("ContributorType2s1")]
        ...
        [Column("content"), CustomValidation(typeof(ContributorType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 12), Editable(false)]
        ...
        public static ContributorType2 FromJObject(JObject jObject) => jObject != null ? new ContributorType2
        {
