...
{
    [Table("manualblocks", Schema = "diku_mod_feesfines")]
    public partial class Block
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Block.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Block), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
