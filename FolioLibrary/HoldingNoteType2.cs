...
namespace FolioLibrary
{
    ...
    public partial class HoldingNoteType2
    {
        ...
        {
            using (var sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.HoldingNoteType.json")))
            {
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("HoldingNoteType2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("HoldingNoteType2s1")]
        ...
        [Column("content"), CustomValidation(typeof(HoldingNoteType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 12), Editable(false)]
        public virtual string Content { get; set; }

        [Display(Name = "Holding Notes", Order = 13)]
        ...
        public static HoldingNoteType2 FromJObject(JObject jObject) => jObject != null ? new HoldingNoteType2
        {
