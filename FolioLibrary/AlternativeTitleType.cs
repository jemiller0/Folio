...
{
    [Table("alternative_title_type", Schema = "uchicago_mod_inventory_storage")]
    public partial class AlternativeTitleType
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(AlternativeTitleType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static AlternativeTitleType FromJObject(JObject jObject) => jObject != null ? new AlternativeTitleType
        {
