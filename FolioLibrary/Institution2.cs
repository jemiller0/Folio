...
{
    // uc.institutions -> uchicago_mod_inventory_storage.locinstitution
    ...
    public partial class Institution2
    {
        ...
        [Column("is_shadow"), Display(Name = "Is Shadow", Order = 4), JsonProperty("isShadow")]
        ...
        [Display(Name = "Creation User", Order = 6), InverseProperty("Institution2s")]
        ...
        [Display(Name = "Last Write User", Order = 10), InverseProperty("Institution2s1")]
        ...
        [Column("content"), CustomValidation(typeof(Institution), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 13), Editable(false)]
        public virtual string Content { get; set; }

        [Display(Name = "Campuss", Order = 14)]
