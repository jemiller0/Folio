...
{
    // uc.holding_notes -> diku_mod_inventory_storage.holdings_record
    // HoldingNote -> Holding
    ...
    public partial class HoldingNote
    {
        ...
        public override string ToString() => $"{{ {nameof(Id)} = {Id}, {nameof(HoldingId)} = {HoldingId}, {nameof(HoldingNoteTypeId)} = {HoldingNoteTypeId}, {nameof(Note)} = {Note}, {nameof(StaffOnly)} = {StaffOnly} }}";
