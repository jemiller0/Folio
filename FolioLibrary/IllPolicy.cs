...
{
    [Table("ill_policy", Schema = "uchicago_mod_inventory_storage")]
    public partial class IllPolicy
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(IllPolicy), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static IllPolicy FromJObject(JObject jObject) => jObject != null ? new IllPolicy
        {
