...
{
    [Table("scheduled_notice", Schema = "uchicago_mod_circulation_storage")]
    public partial class ScheduledNotice
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(ScheduledNotice), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static ScheduledNotice FromJObject(JObject jObject) => jObject != null ? new ScheduledNotice
        {
