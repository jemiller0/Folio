...
namespace FolioLibrary
{
    ...
    public partial class UserSummary2
    {
        ...
        [Display(Order = 2), InverseProperty("UserSummary2s2")]
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("UserSummary2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("UserSummary2s1")]
        ...
        [Column("content"), CustomValidation(typeof(UserSummary), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 12), Editable(false)]
        public virtual string Content { get; set; }

        [Display(Name = "User Summary Open Fees Fines", Order = 13), JsonProperty("openFeesFines")]
        public virtual ICollection<UserSummaryOpenFeesFine> UserSummaryOpenFeesFines { get; set; }

        [Display(Name = "User Summary Open Loans", Order = 14), JsonProperty("openLoans")]
