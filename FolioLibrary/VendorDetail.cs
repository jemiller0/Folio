...
{
    [Table("vendor_detail", Schema = "diku_mod_orders_storage")]
    public partial class VendorDetail
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.VendorDetail.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(VendorDetail), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
