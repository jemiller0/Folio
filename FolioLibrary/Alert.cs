...
{
    [Table("alert", Schema = "diku_mod_orders_storage")]
    public partial class Alert
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Alert.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Alert), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
