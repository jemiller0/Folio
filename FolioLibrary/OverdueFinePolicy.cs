...
{
    [Table("overdue_fine_policy", Schema = "uchicago_mod_feesfines")]
    public partial class OverdueFinePolicy
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(OverdueFinePolicy), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static OverdueFinePolicy FromJObject(JObject jObject) => jObject != null ? new OverdueFinePolicy
        {
