...
namespace FolioLibrary
{
    ...
    public partial class StatisticalCodeType2
    {
        ...
        {
            using (var sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.StatisticalCodeType.json")))
            {
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("StatisticalCodeType2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("StatisticalCodeType2s1")]
        ...
        [Column("content"), CustomValidation(typeof(StatisticalCodeType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 12), Editable(false)]
        public virtual string Content { get; set; }

        [Display(Name = "Statistical Codes", Order = 13)]
        ...
        public static StatisticalCodeType2 FromJObject(JObject jObject) => jObject != null ? new StatisticalCodeType2
        {
