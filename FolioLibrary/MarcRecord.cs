...
{
    [Table("marc_records", Schema = "diku_mod_source_record_storage")]
    public partial class MarcRecord
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(MarcRecord), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
