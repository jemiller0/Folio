...
--DROP VIEW IF EXISTS uc.accounts;
...
--DROP VIEW IF EXISTS uc.account2s;
...
--DROP VIEW IF EXISTS uc.address_categories;
...
--DROP VIEW IF EXISTS uc.addresses;
...
--DROP VIEW IF EXISTS uc.address_types;
...
--DROP VIEW IF EXISTS uc.adjustments;
CREATE VIEW uc.adjustments AS
SELECT
id AS id,
CAST(jsonb->>'credit' AS DECIMAL(19,2)) AS credit,
CAST(jsonb->>'discount' AS DECIMAL(19,2)) AS discount,
CAST(jsonb->>'insurance' AS DECIMAL(19,2)) AS insurance,
CAST(jsonb->>'invoiceId' AS UUID) AS invoice_id,
CAST(jsonb->>'overhead' AS DECIMAL(19,2)) AS overhead,
CAST(jsonb->>'shipment' AS DECIMAL(19,2)) AS shipment,
CAST(jsonb->>'tax1' AS DECIMAL(19,2)) AS tax1,
CAST(jsonb->>'tax2' AS DECIMAL(19,2)) AS tax2,
CAST(jsonb->>'useProRate' AS BOOLEAN) AS use_pro_rate,
jsonb_pretty(jsonb) AS content
FROM diku_mod_orders_storage.adjustment;
--DROP VIEW IF EXISTS uc.agreements;
...
--DROP VIEW IF EXISTS uc.aliases;
...
--DROP VIEW IF EXISTS uc.alternative_title_types;
...
--DROP VIEW IF EXISTS uc.auth_attempts;
...
--DROP VIEW IF EXISTS uc.auth_credentials_histories;
...
--DROP VIEW IF EXISTS uc.budget_tags;
...
--DROP VIEW IF EXISTS uc.budgets;
...
--DROP VIEW IF EXISTS uc.call_number_types;
...
--DROP VIEW IF EXISTS uc.campuses;
...
--DROP VIEW IF EXISTS uc.cancellation_reasons;
...
--DROP VIEW IF EXISTS uc.categories;
...
--DROP VIEW IF EXISTS uc.circulation_rules;
...
--DROP VIEW IF EXISTS uc.classification_types;
...
--DROP VIEW IF EXISTS uc.comments;
...
--DROP VIEW IF EXISTS uc.contact_phone_number_categories;
...
--DROP VIEW IF EXISTS uc.contact_phone_number_types;
...
--DROP VIEW IF EXISTS uc.contact_phone_numbers;
...
--DROP VIEW IF EXISTS uc.contact_email_categories;
...
--DROP VIEW IF EXISTS uc.contact_emails;
...
--DROP VIEW IF EXISTS uc.contact_address_categories;
...
--DROP VIEW IF EXISTS uc.contact_addresses;
...
--DROP VIEW IF EXISTS uc.contact_url_categories;
...
--DROP VIEW IF EXISTS uc.contact_urls;
...
--DROP VIEW IF EXISTS uc.contact_categories;
...
--DROP VIEW IF EXISTS uc.contacts;
...
--DROP VIEW IF EXISTS uc.contributor_name_types;
...
--DROP VIEW IF EXISTS uc.contributor_types;
...
--DROP VIEW IF EXISTS uc.costs;
CREATE VIEW uc.costs AS
SELECT
id AS id,
CAST(jsonb->>'listPrice' AS DECIMAL(19,2)) AS list_price,
...
--DROP VIEW IF EXISTS uc.detail_product_ids;
...
--DROP VIEW IF EXISTS uc.detail_material_types;
CREATE VIEW uc.detail_material_types AS
SELECT
id AS id,
detail_id AS detail_id,
CAST(jsonb AS UUID) AS material_type_id
FROM (SELECT id::text || ordinality::text AS id, id AS detail_id, value AS jsonb FROM diku_mod_orders_storage.details, jsonb_array_elements_text((jsonb->>'materialTypes')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.details;
...
--DROP VIEW IF EXISTS uc.electronic_access_relationships;
...
--DROP VIEW IF EXISTS uc.email_categories;
...
--DROP VIEW IF EXISTS uc.eresources;
...
CAST(jsonb->>'createInventory' AS BOOLEAN) AS create_inventory,
...
--DROP VIEW IF EXISTS uc.event_logs;
...
--DROP VIEW IF EXISTS uc.fee_actions;
...
--DROP VIEW IF EXISTS uc.fiscal_years;
...
--DROP VIEW IF EXISTS uc.fixed_due_date_schedule_schedules;
...
--DROP VIEW IF EXISTS uc.fixed_due_date_schedules;
...
--DROP VIEW IF EXISTS uc.fund_allocation_from;
...
--DROP VIEW IF EXISTS uc.fund_allocation_to;
...
--DROP VIEW IF EXISTS uc.fund_tags;
...
--DROP VIEW IF EXISTS uc.fund_distributions;
...
--DROP VIEW IF EXISTS uc.fund_distribution2s;
...
--DROP VIEW IF EXISTS uc.holding_former_ids;
...
--DROP VIEW IF EXISTS uc.holding_electronic_accesses;
...
--DROP VIEW IF EXISTS uc.holding_notes;
...
--DROP VIEW IF EXISTS uc.extents;
...
--DROP VIEW IF EXISTS uc.index_statements;
...
--DROP VIEW IF EXISTS uc.supplement_statements;
...
--DROP VIEW IF EXISTS uc.holding_entries;
...
--DROP VIEW IF EXISTS uc.holding_statistical_code_ids;
...
--DROP VIEW IF EXISTS uc.holdings;
...
--DROP VIEW IF EXISTS uc.holding_note_types;
...
--DROP VIEW IF EXISTS uc.holding_types;
...
--DROP VIEW IF EXISTS uc.id_types;
...
--DROP VIEW IF EXISTS uc.ill_policies;
...
--DROP VIEW IF EXISTS uc.alternative_titles;
...
--DROP VIEW IF EXISTS uc.editions;
...
--DROP VIEW IF EXISTS uc.identifiers;
...
--DROP VIEW IF EXISTS uc.contributors;
...
--DROP VIEW IF EXISTS uc.subjects;
...
--DROP VIEW IF EXISTS uc.classifications;
...
--DROP VIEW IF EXISTS uc.publications;
...
--DROP VIEW IF EXISTS uc.publication_frequency;
...
--DROP VIEW IF EXISTS uc.publication_range;
...
--DROP VIEW IF EXISTS uc.electronic_accesses;
...
--DROP VIEW IF EXISTS uc.instance_format_ids;
...
--DROP VIEW IF EXISTS uc.physical_descriptions;
...
--DROP VIEW IF EXISTS uc.languages;
...
--DROP VIEW IF EXISTS uc.statistical_code_ids;
...
--DROP VIEW IF EXISTS uc.instances;
...
--DROP VIEW IF EXISTS uc.formats;
...
--DROP VIEW IF EXISTS uc.relationships;
...
--DROP VIEW IF EXISTS uc.relationship_types;
...
--DROP VIEW IF EXISTS uc.source_marc_fields;
...
--DROP VIEW IF EXISTS uc.source_marcs;
...
--DROP VIEW IF EXISTS uc.statuses;
...
--DROP VIEW IF EXISTS uc.instance_types;
...
--DROP VIEW IF EXISTS uc.institutions;
...
--DROP VIEW IF EXISTS uc.interfaces;
...
--DROP VIEW IF EXISTS uc.item_former_ids;
...
--DROP VIEW IF EXISTS uc.item_year_caption;
...
--DROP VIEW IF EXISTS uc.copy_numbers;
...
--DROP VIEW IF EXISTS uc.item_notes;
...
--DROP VIEW IF EXISTS uc.circulation_notes;
...
--DROP VIEW IF EXISTS uc.item_electronic_accesses;
...
--DROP VIEW IF EXISTS uc.item_statistical_code_ids;
...
--DROP VIEW IF EXISTS uc.item_note_types;
...
--DROP VIEW IF EXISTS uc.ledger_fiscal_years;
...
--DROP VIEW IF EXISTS uc.ledgers;
...
--DROP VIEW IF EXISTS uc.libraries;
...
--DROP VIEW IF EXISTS uc.loan_policies;
...
CAST(jsonb#>>'{requestManagement,recalls,alternateGracePeriod,duration}' AS INTEGER) AS request_management_recalls_alternate_grace_period_duration,
CAST(jsonb#>>'{requestManagement,recalls,alternateGracePeriod,intervalId}' AS UUID) AS request_management_recalls_alternate_grace_period_interval_id,
CAST(jsonb#>>'{requestManagement,recalls,minimumGuaranteedLoanPeriod,duration}' AS INTEGER) AS request_management_recalls_minimum_guaranteed_loan_period_duration,
CAST(jsonb#>>'{requestManagement,recalls,minimumGuaranteedLoanPeriod,intervalId}' AS UUID) AS request_management_recalls_minimum_guaranteed_loan_period_interval_id,
CAST(jsonb#>>'{requestManagement,recalls,recallReturnInterval,duration}' AS INTEGER) AS request_management_recalls_recall_return_interval_duration,
CAST(jsonb#>>'{requestManagement,recalls,recallReturnInterval,intervalId}' AS UUID) AS request_management_recalls_recall_return_interval_interval_id,
CAST(jsonb#>>'{requestManagement,holds,alternateCheckoutLoanPeriod,duration}' AS INTEGER) AS request_management_holds_alternate_checkout_loan_period_duration,
CAST(jsonb#>>'{requestManagement,holds,alternateCheckoutLoanPeriod,intervalId}' AS UUID) AS request_management_holds_alternate_checkout_loan_period_interval_id,
CAST(jsonb#>>'{requestManagement,holds,renewItemsWithRequest}' AS BOOLEAN) AS request_management_holds_renew_items_with_request,
CAST(jsonb#>>'{requestManagement,holds,alternateRenewalLoanPeriod,duration}' AS INTEGER) AS request_management_holds_alternate_renewal_loan_period_duration,
CAST(jsonb#>>'{requestManagement,holds,alternateRenewalLoanPeriod,intervalId}' AS UUID) AS request_management_holds_alternate_renewal_loan_period_interval_id,
CAST(jsonb#>>'{requestManagement,pages,alternateCheckoutLoanPeriod,duration}' AS INTEGER) AS request_management_pages_alternate_checkout_loan_period_duration,
CAST(jsonb#>>'{requestManagement,pages,alternateCheckoutLoanPeriod,intervalId}' AS UUID) AS request_management_pages_alternate_checkout_loan_period_interval_id,
CAST(jsonb#>>'{requestManagement,pages,renewItemsWithRequest}' AS BOOLEAN) AS request_management_pages_renew_items_with_request,
CAST(jsonb#>>'{requestManagement,pages,alternateRenewalLoanPeriod,duration}' AS INTEGER) AS request_management_pages_alternate_renewal_loan_period_duration,
CAST(jsonb#>>'{requestManagement,pages,alternateRenewalLoanPeriod,intervalId}' AS UUID) AS request_management_pages_alternate_renewal_loan_period_interval_id,
uc.TIMESTAMP_CAST(jsonb#>>'{metadata,createdDate}') AS created_date,
CAST(jsonb#>>'{metadata,createdByUserId}' AS UUID) AS created_by_user_id,
CAST(jsonb#>>'{metadata,createdByUsername}' AS VARCHAR(1024)) AS created_by_username,
uc.TIMESTAMP_CAST(jsonb#>>'{metadata,updatedDate}') AS updated_date,
...
--DROP VIEW IF EXISTS uc.loan_types;
...
--DROP VIEW IF EXISTS uc.location_service_point_ids;
...
--DROP VIEW IF EXISTS uc.locations;
...
--DROP VIEW IF EXISTS uc.material_types;
...
--DROP VIEW IF EXISTS uc.mode_of_issuances;
...
--DROP VIEW IF EXISTS uc.notes2;
CREATE VIEW uc.notes2 AS
SELECT
id AS id,
CAST(jsonb->>'link' AS VARCHAR(1024)) AS link,
CAST(jsonb->>'text' AS VARCHAR(1024)) AS text,
CAST(jsonb->>'domain' AS VARCHAR(1024)) AS domain,
CAST(jsonb->>'creatorUserName' AS VARCHAR(1024)) AS creator_user_name,
CAST(jsonb->>'creatorLastName' AS VARCHAR(1024)) AS creator_last_name,
CAST(jsonb->>'creatorFirstName' AS VARCHAR(1024)) AS creator_first_name,
CAST(jsonb->>'creatorMiddleName' AS VARCHAR(1024)) AS creator_middle_name,
uc.TIMESTAMP_CAST(jsonb#>>'{metadata,createdDate}') AS created_date,
CAST(jsonb#>>'{metadata,createdByUserId}' AS UUID) AS created_by_user_id,
CAST(jsonb#>>'{metadata,createdByUsername}' AS VARCHAR(1024)) AS created_by_username,
uc.TIMESTAMP_CAST(jsonb#>>'{metadata,updatedDate}') AS updated_date,
...
--DROP VIEW IF EXISTS uc.order_notes;
...
--DROP VIEW IF EXISTS uc.orders;
CREATE VIEW uc.orders AS
SELECT
id AS id,
CAST(jsonb->>'adjustment' AS UUID) AS adjustment_id,
...
CAST(jsonb->>'totalEstimatedPrice' AS DECIMAL(19,2)) AS total_estimated_price,
CAST(jsonb->>'totalItems' AS INTEGER) AS total_items,
...
--DROP VIEW IF EXISTS uc.order_item_alerts;
...
--DROP VIEW IF EXISTS uc.order_item_claims;
...
--DROP VIEW IF EXISTS uc.order_item_contributors;
...
--DROP VIEW IF EXISTS uc.order_item_product_ids;
...
--DROP VIEW IF EXISTS uc.order_item_material_types;
CREATE VIEW uc.order_item_material_types AS
SELECT
id AS id,
order_item_id AS order_item_id,
CAST(jsonb AS VARCHAR(1024)) AS content
FROM (SELECT id::text || ordinality::text AS id, id AS order_item_id, value AS jsonb FROM diku_mod_orders_storage.po_line, jsonb_array_elements_text((jsonb#>>'{details,materialTypes}')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.order_item_fund_distributions;
...
--DROP VIEW IF EXISTS uc.order_item_locations;
...
--DROP VIEW IF EXISTS uc.order_item_volumes;
...
--DROP VIEW IF EXISTS uc.order_item_reporting_codes;
...
--DROP VIEW IF EXISTS uc.order_item_tags;
...
--DROP VIEW IF EXISTS uc.order_items;
...
CAST(jsonb->>'acquisitionMethod' AS VARCHAR(1024)) AS acquisition_method,
CAST(jsonb#>>'{adjustment,credit}' AS DECIMAL(19,2)) AS adjustment_credit,
CAST(jsonb#>>'{adjustment,discount}' AS DECIMAL(19,2)) AS adjustment_discount,
CAST(jsonb#>>'{adjustment,insurance}' AS DECIMAL(19,2)) AS adjustment_insurance,
CAST(jsonb#>>'{adjustment,invoiceId}' AS UUID) AS adjustment_invoice_id,
CAST(jsonb#>>'{adjustment,overhead}' AS DECIMAL(19,2)) AS adjustment_overhead,
CAST(jsonb#>>'{adjustment,shipment}' AS DECIMAL(19,2)) AS adjustment_shipment,
CAST(jsonb#>>'{adjustment,tax1}' AS DECIMAL(19,2)) AS adjustment_tax1,
CAST(jsonb#>>'{adjustment,tax2}' AS DECIMAL(19,2)) AS adjustment_tax2,
CAST(jsonb#>>'{adjustment,useProRate}' AS BOOLEAN) AS adjustment_use_pro_rate,
...
CAST(jsonb#>>'{cost,listPrice}' AS DECIMAL(19,2)) AS cost_list_price,
...
CAST(jsonb#>>'{eresource,createInventory}' AS BOOLEAN) AS eresource_create_inventory,
...
--DROP VIEW IF EXISTS uc.order_item_locations2;
...
--DROP VIEW IF EXISTS uc.service_point_owners;
...
--DROP VIEW IF EXISTS uc.patron_notice_policy_loan_notices;
...
--DROP VIEW IF EXISTS uc.patron_notice_policy_fee_fine_notices;
...
--DROP VIEW IF EXISTS uc.patron_notice_policy_request_notices;
...
--DROP VIEW IF EXISTS uc.patron_notice_policies;
...
--DROP VIEW IF EXISTS uc.payments;
...
--DROP VIEW IF EXISTS uc.permission_tags;
...
--DROP VIEW IF EXISTS uc.permission_sub_permissions;
...
--DROP VIEW IF EXISTS uc.permission_child_of;
...
--DROP VIEW IF EXISTS uc.permission_granted_to;
...
--DROP VIEW IF EXISTS uc.permissions;
...
--DROP VIEW IF EXISTS uc.permissions_user_permissions;
...
--DROP VIEW IF EXISTS uc.permissions_users;
...
--DROP VIEW IF EXISTS uc.phone_number_categories;
...
--DROP VIEW IF EXISTS uc.phone_number_types;
...
--DROP VIEW IF EXISTS uc.phone_numbers;
...
--DROP VIEW IF EXISTS uc.physical_volumes;
...
--DROP VIEW IF EXISTS uc.physicals;
...
--DROP VIEW IF EXISTS uc.proxies;
...
--DROP VIEW IF EXISTS uc.refunds;
...
--DROP VIEW IF EXISTS uc.reporting_codes;
...
--DROP VIEW IF EXISTS uc.request_tags;
...
--DROP VIEW IF EXISTS uc.requests;
...
--DROP VIEW IF EXISTS uc.request_policy_request_types;
...
--DROP VIEW IF EXISTS uc.request_policies;
...
--DROP VIEW IF EXISTS uc.service_point_staff_slips;
...
--DROP VIEW IF EXISTS uc.service_points;
...
--DROP VIEW IF EXISTS uc.service_point_user_service_points;
...
--DROP VIEW IF EXISTS uc.service_point_users;
...
--DROP VIEW IF EXISTS uc.sources;
...
--DROP VIEW IF EXISTS uc.staff_slip_staff_slips;
...
--DROP VIEW IF EXISTS uc.staff_slips;
...
--DROP VIEW IF EXISTS uc.statistical_codes;
...
--DROP VIEW IF EXISTS uc.statistical_code_types;
...
--DROP VIEW IF EXISTS uc.transactions;
...
--DROP VIEW IF EXISTS uc.transfers;
...
--DROP VIEW IF EXISTS uc.transfer_criterias;
...
--DROP VIEW IF EXISTS uc.url_categories;
...
--DROP VIEW IF EXISTS uc.user_addresses;
...
--DROP VIEW IF EXISTS uc.user_tags;
...
--DROP VIEW IF EXISTS uc.vendor_aliases;
...
--DROP VIEW IF EXISTS uc.vendor_address_categories;
...
--DROP VIEW IF EXISTS uc.vendor_addresses;
...
--DROP VIEW IF EXISTS uc.vendor_phone_number_categories;
...
--DROP VIEW IF EXISTS uc.vendor_phone_number_types;
...
CAST(jsonb AS VARCHAR(1024)) AS content
FROM (SELECT id::text || ordinality::text AS id, id AS vendor_phone_number_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_id, value AS jsonb FROM diku_mod_vendors.vendor, jsonb_array_elements((jsonb->>'phone_numbers')::jsonb) WITH ORDINALITY) a, jsonb_array_elements_text((jsonb->>'types')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.vendor_phone_numbers;
...
--DROP VIEW IF EXISTS uc.email_address_categories;
...
--DROP VIEW IF EXISTS uc.vendor_emails;
...
--DROP VIEW IF EXISTS uc.vendor_url_categories;
...
--DROP VIEW IF EXISTS uc.vendor_urls;
...
--DROP VIEW IF EXISTS uc.vendor_contact_phone_number_categories;
CREATE VIEW uc.vendor_contact_phone_number_categories AS
SELECT
id AS id,
vendor_contact_phone_number_id AS vendor_contact_phone_number_id,
CAST(jsonb AS VARCHAR(1024)) AS content
FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_phone_number_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_id, value AS jsonb FROM diku_mod_vendors.vendor, jsonb_array_elements((jsonb->>'contacts')::jsonb) WITH ORDINALITY) a, jsonb_array_elements((jsonb->>'phone_numbers')::jsonb) WITH ORDINALITY) a, jsonb_array_elements_text((jsonb->>'categories')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.vendor_contact_phone_number_types;
CREATE VIEW uc.vendor_contact_phone_number_types AS
SELECT
id AS id,
vendor_contact_phone_number_id AS vendor_contact_phone_number_id,
CAST(jsonb AS VARCHAR(1024)) AS content
FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_phone_number_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_id, value AS jsonb FROM diku_mod_vendors.vendor, jsonb_array_elements((jsonb->>'contacts')::jsonb) WITH ORDINALITY) a, jsonb_array_elements((jsonb->>'phone_numbers')::jsonb) WITH ORDINALITY) a, jsonb_array_elements_text((jsonb->>'types')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.vendor_contact_phone_numbers;
CREATE VIEW uc.vendor_contact_phone_numbers AS
SELECT
id AS id,
vendor_contact_id AS vendor_contact_id,
CAST(jsonb->>'id' AS UUID) AS id2,
CAST(jsonb->>'phone_number' AS VARCHAR(1024)) AS phone_number,
CAST(jsonb->>'isPrimary' AS BOOLEAN) AS is_primary,
CAST(jsonb->>'language' AS VARCHAR(1024)) AS language
FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_id, value AS jsonb FROM diku_mod_vendors.vendor, jsonb_array_elements((jsonb->>'contacts')::jsonb) WITH ORDINALITY) a, jsonb_array_elements((jsonb->>'phone_numbers')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.vendor_contact_email_categories;
CREATE VIEW uc.vendor_contact_email_categories AS
SELECT
id AS id,
vendor_contact_email_id AS vendor_contact_email_id,
CAST(jsonb AS VARCHAR(1024)) AS content
FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_email_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_id, value AS jsonb FROM diku_mod_vendors.vendor, jsonb_array_elements((jsonb->>'contacts')::jsonb) WITH ORDINALITY) a, jsonb_array_elements((jsonb->>'emails')::jsonb) WITH ORDINALITY) a, jsonb_array_elements_text((jsonb->>'categories')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.vendor_contact_emails;
CREATE VIEW uc.vendor_contact_emails AS
SELECT
id AS id,
vendor_contact_id AS vendor_contact_id,
CAST(jsonb->>'id' AS UUID) AS id2,
...
CAST(jsonb->>'isPrimary' AS BOOLEAN) AS is_primary,
CAST(jsonb->>'language' AS VARCHAR(1024)) AS language
FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_id, value AS jsonb FROM diku_mod_vendors.vendor, jsonb_array_elements((jsonb->>'contacts')::jsonb) WITH ORDINALITY) a, jsonb_array_elements((jsonb->>'emails')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.vendor_contact_address_categories;
CREATE VIEW uc.vendor_contact_address_categories AS
SELECT
id AS id,
vendor_contact_address_id AS vendor_contact_address_id,
CAST(jsonb AS VARCHAR(1024)) AS content
FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_address_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_id, value AS jsonb FROM diku_mod_vendors.vendor, jsonb_array_elements((jsonb->>'contacts')::jsonb) WITH ORDINALITY) a, jsonb_array_elements((jsonb->>'addresses')::jsonb) WITH ORDINALITY) a, jsonb_array_elements_text((jsonb->>'categories')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.vendor_contact_addresses;
CREATE VIEW uc.vendor_contact_addresses AS
SELECT
id AS id,
vendor_contact_id AS vendor_contact_id,
CAST(jsonb->>'id' AS UUID) AS id2,
...
CAST(jsonb->>'isPrimary' AS BOOLEAN) AS is_primary,
CAST(jsonb->>'language' AS VARCHAR(1024)) AS language
FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_id, value AS jsonb FROM diku_mod_vendors.vendor, jsonb_array_elements((jsonb->>'contacts')::jsonb) WITH ORDINALITY) a, jsonb_array_elements((jsonb->>'addresses')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.vendor_contact_url_categories;
CREATE VIEW uc.vendor_contact_url_categories AS
SELECT
id AS id,
vendor_contact_url_id AS vendor_contact_url_id,
CAST(jsonb AS VARCHAR(1024)) AS content
FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_url_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_id, value AS jsonb FROM diku_mod_vendors.vendor, jsonb_array_elements((jsonb->>'contacts')::jsonb) WITH ORDINALITY) a, jsonb_array_elements((jsonb->>'urls')::jsonb) WITH ORDINALITY) a, jsonb_array_elements_text((jsonb->>'categories')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.vendor_contact_urls;
CREATE VIEW uc.vendor_contact_urls AS
SELECT
id AS id,
vendor_contact_id AS vendor_contact_id,
CAST(jsonb->>'id' AS UUID) AS id2,
...
CAST(jsonb->>'isPrimary' AS BOOLEAN) AS is_primary,
CAST(jsonb->>'notes' AS VARCHAR(1024)) AS notes
FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_id, value AS jsonb FROM diku_mod_vendors.vendor, jsonb_array_elements((jsonb->>'contacts')::jsonb) WITH ORDINALITY) a, jsonb_array_elements((jsonb->>'urls')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.vendor_contact_categories;
CREATE VIEW uc.vendor_contact_categories AS
SELECT
id AS id,
vendor_contact_id AS vendor_contact_id,
CAST(jsonb->>'id' AS UUID) AS id2,
CAST(jsonb->>'value' AS VARCHAR(1024)) AS value
FROM (SELECT id::text || ordinality::text AS id, id AS vendor_contact_id, value AS jsonb FROM (SELECT id::text || ordinality::text AS id, id AS vendor_id, value AS jsonb FROM diku_mod_vendors.vendor, jsonb_array_elements((jsonb->>'contacts')::jsonb) WITH ORDINALITY) a, jsonb_array_elements((jsonb->>'categories')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.vendor_contacts;
...
CAST(jsonb->>'notes' AS VARCHAR(1024)) AS notes,
CAST(jsonb->>'inactive' AS BOOLEAN) AS inactive
FROM (SELECT id::text || ordinality::text AS id, id AS vendor_id, value AS jsonb FROM diku_mod_vendors.vendor, jsonb_array_elements((jsonb->>'contacts')::jsonb) WITH ORDINALITY) a;
--DROP VIEW IF EXISTS uc.vendor_agreements;
...
--DROP VIEW IF EXISTS uc.currencies;
...
--DROP VIEW IF EXISTS uc.vendor_interfaces;
...
--DROP VIEW IF EXISTS uc.vendor_accounts;
...
--DROP VIEW IF EXISTS uc.vendor_vendor_types;
...
--DROP VIEW IF EXISTS uc.vendor_changelogs;
...
--DROP VIEW IF EXISTS uc.vendors;
...
--DROP VIEW IF EXISTS uc.vendor_details;
...
--DROP VIEW IF EXISTS uc.vendor_types;
