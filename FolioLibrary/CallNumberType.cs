...
{
    [Table("call_number_type", Schema = "uchicago_mod_inventory_storage")]
    public partial class CallNumberType
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(CallNumberType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static CallNumberType FromJObject(JObject jObject) => jObject != null ? new CallNumberType
        {
