...
{
    [Table("request", Schema = "diku_mod_circulation_storage")]
    public partial class Request
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Request.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Request), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
