...
{
    // uc.rollover_budget_acquisitions_units -> uchicago_mod_finance_storage.ledger_fiscal_year_rollover_budget
    // RolloverBudgetAcquisitionsUnit -> RolloverBudget
    [DisplayColumn(nameof(Id)), DisplayName("Rollover Budget Acquisitions Units"), Table("rollover_budget_acquisitions_units", Schema = "uc")]
    public partial class RolloverBudgetAcquisitionsUnit
    {
        ...
        public static RolloverBudgetAcquisitionsUnit FromJObject(JValue jObject) => jObject != null ? new RolloverBudgetAcquisitionsUnit
        {
