...
{
    [Table("locinstitution", Schema = "diku_mod_inventory_storage")]
    public partial class Institution
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Institution.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Institution), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
