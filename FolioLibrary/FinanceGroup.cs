...
{
    [Table("groups", Schema = "uchicago_mod_finance_storage")]
    public partial class FinanceGroup
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(FinanceGroup), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static FinanceGroup FromJObject(JObject jObject) => jObject != null ? new FinanceGroup
        {
