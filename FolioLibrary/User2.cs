...
{
    // uc.users -> uchicago_mod_users.users
    // User2 -> User
    ...
    public partial class User2
    {
        ...
        [Column("pronouns"), Display(Order = 9), JsonProperty("personal.pronouns"), StringLength(300)]
        public virtual string Pronouns { get; set; }

        [Column("name"), Display(Order = 10), Editable(false), StringLength(1024)]
        public virtual string Name { get; set; }

        [Column("last_name"), Display(Name = "Last Name", Order = 11), JsonProperty("personal.lastName"), Required, StringLength(1024)]
        public virtual string LastName { get; set; }

        [Column("first_name"), Display(Name = "First Name", Order = 12), JsonProperty("personal.firstName"), StringLength(1024)]
        public virtual string FirstName { get; set; }

        [Column("middle_name"), Display(Name = "Middle Name", Order = 13), JsonProperty("personal.middleName"), StringLength(1024)]
        public virtual string MiddleName { get; set; }

        [Column("preferred_first_name"), Display(Name = "Preferred First Name", Order = 14), JsonProperty("personal.preferredFirstName"), StringLength(1024)]
        public virtual string PreferredFirstName { get; set; }

        [Column("email"), DataType(DataType.EmailAddress), Display(Name = "Email Address", Order = 15), JsonProperty("personal.email"), RegularExpression(@"^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$"), Required, StringLength(1024)]
        public virtual string EmailAddress { get; set; }

        [Column("phone"), DataType(DataType.PhoneNumber), Display(Name = "Phone Number", Order = 16), JsonProperty("personal.phone"), RegularExpression(@"^(\+\d{1,3} ?)?(\(?\d{3}\)?[ \-]?)?(\d{2})?\d[ \-]?\d{4}$"), StringLength(1024)]
        public virtual string PhoneNumber { get; set; }

        [Column("mobile_phone"), DataType(DataType.PhoneNumber), Display(Name = "Mobile Phone Number", Order = 17), JsonProperty("personal.mobilePhone"), RegularExpression(@"^(\+\d{1,3} ?)?(\(?\d{3}\)?[ \-]?)?(\d{2})?\d[ \-]?\d{4}$"), StringLength(1024)]
        public virtual string MobilePhoneNumber { get; set; }

        [Column("date_of_birth"), DataType(DataType.Date), Display(Name = "Birth Date", Order = 18), DisplayFormat(DataFormatString = "{0:d}", ApplyFormatInEditMode = true), JsonProperty("personal.dateOfBirth")]
        public virtual DateTime? BirthDate { get; set; }

        [Display(Name = "Preferred Contact Type", Order = 19)]
        public virtual ContactType PreferredContactType { get; set; }

        [Column("preferred_contact_type_id"), Display(Name = "Preferred Contact Type", Order = 20), JsonProperty("personal.preferredContactTypeId"), Required, StringLength(1024)]
        public virtual string PreferredContactTypeId { get; set; }

        [Column("profile_picture_link"), Display(Name = "Profile Picture Link", Order = 21), JsonProperty("personal.profilePictureLink"), StringLength(1024)]
        public virtual string ProfilePictureLink { get; set; }

        [Column("enrollment_date"), DataType(DataType.Date), Display(Name = "Start Date", Order = 22), DisplayFormat(DataFormatString = "{0:d}", ApplyFormatInEditMode = true), JsonProperty("enrollmentDate")]
        public virtual DateTime? StartDate { get; set; }

        [Column("expiration_date"), DataType(DataType.Date), Display(Name = "End Date", Order = 23), DisplayFormat(DataFormatString = "{0:d}", ApplyFormatInEditMode = true), JsonProperty("expirationDate")]
        public virtual DateTime? EndDate { get; set; }

        [Column("source"), Display(Order = 24), JsonProperty("customFields.source"), RegularExpression(@"^(Library|University)$"), Required, StringLength(1024)]
        public virtual string Source { get; set; }

        [Column("source_id"), Display(Name = "Source Id", Order = 25), JsonProperty("customFields.dataSource"), StringLength(1024)]
        public virtual string SourceId { get; set; }

        [Column("category_code"), Display(Name = "Category Code", Order = 26), JsonProperty("customFields.category"), StringLength(1024)]
        public virtual string CategoryCode { get; set; }

        [Column("category_id"), Display(Name = "Category Id", Order = 27), JsonProperty("customFields.statCategory"), StringLength(1024)]
        public virtual string CategoryId { get; set; }

        [Column("status"), Display(Order = 28), Editable(false), JsonProperty("customFields.status"), StringLength(1024)]
        public virtual string Status { get; set; }

        [Column("statuses"), Display(Order = 29), Editable(false), JsonProperty("customFields.statuses"), StringLength(1024)]
        public virtual string Statuses { get; set; }

        [Column("staff_status"), Display(Name = "Staff Status", Order = 30), Editable(false), JsonProperty("customFields.staffStatus"), StringLength(1024)]
        public virtual string StaffStatus { get; set; }

        [Column("staff_privileges"), Display(Name = "Staff Privileges", Order = 31), Editable(false), JsonProperty("customFields.staffPrivileges"), StringLength(1024)]
        public virtual string StaffPrivileges { get; set; }

        [Column("staff_division"), Display(Name = "Staff Division", Order = 32), Editable(false), JsonProperty("customFields.staffDivision"), StringLength(1024)]
        public virtual string StaffDivision { get; set; }

        [Column("staff_department"), Display(Name = "Staff Department", Order = 33), Editable(false), JsonProperty("customFields.staffDepartment"), StringLength(1024)]
        public virtual string StaffDepartment { get; set; }

        [Column("student_id"), Display(Name = "Student Id", Order = 34), Editable(false), JsonProperty("customFields.studentId"), StringLength(1024)]
        public virtual string StudentId { get; set; }

        [Column("student_status"), Display(Name = "Student Status", Order = 35), Editable(false), JsonProperty("customFields.studentStatus"), StringLength(1024)]
        public virtual string StudentStatus { get; set; }

        [Column("student_restriction"), Display(Name = "Student Restriction", Order = 36), Editable(false), JsonProperty("customFields.studentRestriction")]
        public virtual bool? StudentRestriction { get; set; }

        [Column("student_division"), Display(Name = "Student Division", Order = 37), Editable(false), JsonProperty("customFields.studentDivision"), StringLength(1024)]
        public virtual string StudentDivision { get; set; }

        [Column("student_department"), Display(Name = "Student Department", Order = 38), Editable(false), JsonProperty("customFields.studentDepartment"), StringLength(1024)]
        public virtual string StudentDepartment { get; set; }

        [Column("deceased"), Display(Order = 39), JsonProperty("customFields.deceased")]
        public virtual bool? Deceased { get; set; }

        [Column("collections"), Display(Order = 40), JsonProperty("customFields.collections")]
        ...
        [Display(Name = "Creation User", Order = 42), InverseProperty("User2s")]
        ...
        [Display(Name = "Last Write User", Order = 46), InverseProperty("User2s1")]
        ...
        [Display(Name = "Formats 1", Order = 139)]
        public virtual ICollection<Format> Formats1 { get; set; }

        [Display(Name = "Funds", Order = 140)]
        public virtual ICollection<Fund2> Fund2s { get; set; }

        [Display(Name = "Funds 1", Order = 141)]
        public virtual ICollection<Fund2> Fund2s1 { get; set; }

        [Display(Name = "Groups", Order = 142)]
        public virtual ICollection<Group2> Group2s { get; set; }

        [Display(Name = "Groups 1", Order = 143)]
        public virtual ICollection<Group2> Group2s1 { get; set; }

        [Display(Name = "Holdings", Order = 144)]
        public virtual ICollection<Holding2> Holding2s { get; set; }

        [Display(Name = "Holdings 1", Order = 145)]
        public virtual ICollection<Holding2> Holding2s1 { get; set; }

        [Display(Name = "Holding Donors", Order = 146)]
        public virtual ICollection<HoldingDonor> HoldingDonors { get; set; }

        [Display(Name = "Holding Donors 1", Order = 147)]
        public virtual ICollection<HoldingDonor> HoldingDonors1 { get; set; }

        [Display(Name = "Holding Notes", Order = 148)]
        public virtual ICollection<HoldingNote> HoldingNotes { get; set; }

        [Display(Name = "Holding Notes 1", Order = 149)]
        public virtual ICollection<HoldingNote> HoldingNotes1 { get; set; }

        [Display(Name = "Holding Note Types", Order = 150)]
        public virtual ICollection<HoldingNoteType2> HoldingNoteType2s { get; set; }

        [Display(Name = "Holding Note Types 1", Order = 151)]
        public virtual ICollection<HoldingNoteType2> HoldingNoteType2s1 { get; set; }

        [Display(Name = "Holding Types", Order = 152)]
        public virtual ICollection<HoldingType2> HoldingType2s { get; set; }

        [Display(Name = "Holding Types 1", Order = 153)]
        public virtual ICollection<HoldingType2> HoldingType2s1 { get; set; }

        [Display(Name = "Hrid Settings", Order = 154)]
        public virtual ICollection<HridSetting2> HridSetting2s { get; set; }

        [Display(Name = "Hrid Settings 1", Order = 155)]
        public virtual ICollection<HridSetting2> HridSetting2s1 { get; set; }

        [Display(Name = "Id Types", Order = 156)]
        public virtual ICollection<IdType2> IdType2s { get; set; }

        [Display(Name = "Id Types 1", Order = 157)]
        public virtual ICollection<IdType2> IdType2s1 { get; set; }

        [Display(Name = "Ill Policys", Order = 158)]
        public virtual ICollection<IllPolicy2> IllPolicy2s { get; set; }

        [Display(Name = "Ill Policys 1", Order = 159)]
        ...
        public static User2 FromJObject(JObject jObject) => jObject != null ? new User2
        {
            ...
            Pronouns = (string)jObject.SelectToken("personal.pronouns"),
            ...
            BirthDate = ((DateTime?)jObject.SelectToken("personal.dateOfBirth"))?.ToUniversalTime(),
            PreferredContactTypeId = (string)jObject.SelectToken("personal.preferredContactTypeId"),
            ProfilePictureLink = (string)jObject.SelectToken("personal.profilePictureLink"),
            StartDate = ((DateTime?)jObject.SelectToken("enrollmentDate"))?.ToUniversalTime(),
            EndDate = ((DateTime?)jObject.SelectToken("expirationDate"))?.ToUniversalTime(),
            Source = (string)jObject.SelectToken("customFields.source"),
            SourceId = (string)jObject.SelectToken("customFields.dataSource"),
            CategoryCode = (string)jObject.SelectToken("customFields.category"),
            CategoryId = (string)jObject.SelectToken("customFields.statCategory"),
        ...
        public JObject ToJObject() => new JObject(
            ...
            new JProperty("personal", new JObject(
                new JProperty("pronouns", Pronouns),
            ...
            new JProperty("customFields", new JObject(
                ...
                new JProperty("dataSource", SourceId),
                new JProperty("category", CategoryCode),
                new JProperty("statCategory", CategoryId),
            ...
            new JProperty("preferredEmailCommunication", PreferredEmailCommunications?.Select(pec => pec.ToJObject())),
