...
namespace FolioLibrary
{
    ...
    public partial class User2
    {
        ...
        [Column("profile_picture_link"), Display(Name = "Profile Picture Link", Order = 20), JsonProperty("personal.profilePictureLink"), StringLength(1024)]
        public virtual string ProfilePictureLink { get; set; }

        [Column("enrollment_date"), DataType(DataType.Date), Display(Name = "Start Date", Order = 21), DisplayFormat(DataFormatString = "{0:d}", ApplyFormatInEditMode = true), JsonProperty("enrollmentDate")]
        public virtual DateTime? StartDate { get; set; }

        [Column("expiration_date"), DataType(DataType.Date), Display(Name = "End Date", Order = 22), DisplayFormat(DataFormatString = "{0:d}", ApplyFormatInEditMode = true), JsonProperty("expirationDate")]
        public virtual DateTime? EndDate { get; set; }

        [Column("source"), Display(Order = 23), JsonProperty("customFields.source"), RegularExpression(@"^(Library|University)$"), Required, StringLength(1024)]
        public virtual string Source { get; set; }

        [Column("category_code"), Display(Name = "Category Code", Order = 24), JsonProperty("customFields.category"), StringLength(1024)]
        public virtual string CategoryCode { get; set; }

        [Display(Order = 25)]
        public virtual UserCategory Category { get; set; }

        [Column("category_id"), Display(Name = "Category", Order = 26), JsonProperty("customFields.category_2"), StringLength(1024)]
        public virtual string CategoryId { get; set; }

        [Column("status"), Display(Order = 27), Editable(false), JsonProperty("customFields.status"), StringLength(1024)]
        public virtual string Status { get; set; }

        [Column("statuses"), Display(Order = 28), Editable(false), JsonProperty("customFields.statuses"), StringLength(1024)]
        public virtual string Statuses { get; set; }

        [Column("staff_status"), Display(Name = "Staff Status", Order = 29), Editable(false), JsonProperty("customFields.staffStatus"), StringLength(1024)]
        public virtual string StaffStatus { get; set; }

        [Column("staff_privileges"), Display(Name = "Staff Privileges", Order = 30), Editable(false), JsonProperty("customFields.staffPrivileges"), StringLength(1024)]
        public virtual string StaffPrivileges { get; set; }

        [Column("staff_division"), Display(Name = "Staff Division", Order = 31), Editable(false), JsonProperty("customFields.staffDivision"), StringLength(1024)]
        public virtual string StaffDivision { get; set; }

        [Column("staff_department"), Display(Name = "Staff Department", Order = 32), Editable(false), JsonProperty("customFields.staffDepartment"), StringLength(1024)]
        public virtual string StaffDepartment { get; set; }

        [Column("student_id"), Display(Name = "Student Id", Order = 33), Editable(false), JsonProperty("customFields.studentId"), StringLength(1024)]
        public virtual string StudentId { get; set; }

        [Column("student_status"), Display(Name = "Student Status", Order = 34), Editable(false), JsonProperty("customFields.studentStatus"), StringLength(1024)]
        public virtual string StudentStatus { get; set; }

        [Column("student_restriction"), Display(Name = "Student Restriction", Order = 35), Editable(false), JsonProperty("customFields.studentRestriction")]
        public virtual bool? StudentRestriction { get; set; }

        [Column("student_division"), Display(Name = "Student Division", Order = 36), Editable(false), JsonProperty("customFields.studentDivision"), StringLength(1024)]
        public virtual string StudentDivision { get; set; }

        [Column("student_department"), Display(Name = "Student Department", Order = 37), Editable(false), JsonProperty("customFields.studentDepartment"), StringLength(1024)]
        public virtual string StudentDepartment { get; set; }

        [Column("deceased"), Display(Order = 38), JsonProperty("customFields.deceased")]
        public virtual bool? Deceased { get; set; }

        [Column("collections"), Display(Order = 39), JsonProperty("customFields.collections")]
        public virtual bool? Collections { get; set; }

        [Column("created_date"), DataType(DataType.DateTime), Display(Name = "Creation Time", Order = 40), DisplayFormat(DataFormatString = "{0:g}"), Editable(false), JsonProperty("metadata.createdDate")]
        public virtual DateTime? CreationTime { get; set; }

        [Display(Name = "Creation User", Order = 41), InverseProperty("User2s")]
        public virtual User2 CreationUser { get; set; }

        [Column("created_by_user_id"), Display(Name = "Creation User", Order = 42), Editable(false), JsonProperty("metadata.createdByUserId")]
        public virtual Guid? CreationUserId { get; set; }

        [Column("created_by_username"), JsonProperty("metadata.createdByUsername"), ScaffoldColumn(false), StringLength(1024)]
        public virtual string CreationUserUsername { get; set; }

        [Column("updated_date"), DataType(DataType.DateTime), Display(Name = "Last Write Time", Order = 44), DisplayFormat(DataFormatString = "{0:g}"), Editable(false), JsonProperty("metadata.updatedDate")]
        public virtual DateTime? LastWriteTime { get; set; }

        [Display(Name = "Last Write User", Order = 45), InverseProperty("User2s1")]
        public virtual User2 LastWriteUser { get; set; }

        [Column("updated_by_user_id"), Display(Name = "Last Write User", Order = 46), Editable(false), JsonProperty("metadata.updatedByUserId")]
        public virtual Guid? LastWriteUserId { get; set; }

        [Column("updated_by_username"), JsonProperty("metadata.updatedByUsername"), ScaffoldColumn(false), StringLength(1024)]
        public virtual string LastWriteUserUsername { get; set; }

        [Column("content"), CustomValidation(typeof(User), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 48), Editable(false)]
        public virtual string Content { get; set; }

        [Display(Name = "Acquisition Methods", Order = 49)]
        public virtual ICollection<AcquisitionMethod2> AcquisitionMethod2s { get; set; }

        [Display(Name = "Acquisition Methods 1", Order = 50)]
        public virtual ICollection<AcquisitionMethod2> AcquisitionMethod2s1 { get; set; }

        [Display(Name = "Acquisitions Units", Order = 51)]
        public virtual ICollection<AcquisitionsUnit2> AcquisitionsUnit2s { get; set; }

        [Display(Name = "Acquisitions Units 1", Order = 52)]
        public virtual ICollection<AcquisitionsUnit2> AcquisitionsUnit2s1 { get; set; }

        [Display(Name = "Actual Cost Records", Order = 53)]
        public virtual ICollection<ActualCostRecord2> ActualCostRecord2s { get; set; }

        [Display(Name = "Actual Cost Records 1", Order = 54)]
        public virtual ICollection<ActualCostRecord2> ActualCostRecord2s1 { get; set; }

        [Display(Order = 55)]
        public virtual ICollection<Address> Addresses { get; set; }

        [Display(Name = "Addresses 1", Order = 56)]
        public virtual ICollection<Address> Addresses1 { get; set; }

        [Display(Name = "Address Types", Order = 57)]
        public virtual ICollection<AddressType2> AddressType2s { get; set; }

        [Display(Name = "Address Types 1", Order = 58)]
        public virtual ICollection<AddressType2> AddressType2s1 { get; set; }

        [Display(Name = "Alternative Title Types", Order = 59)]
        public virtual ICollection<AlternativeTitleType2> AlternativeTitleType2s { get; set; }

        [Display(Name = "Alternative Title Types 1", Order = 60)]
        public virtual ICollection<AlternativeTitleType2> AlternativeTitleType2s1 { get; set; }

        [Display(Name = "Auth Attempts", Order = 61)]
        public virtual ICollection<AuthAttempt2> AuthAttempt2s { get; set; }

        [Display(Name = "Auth Credentials Historys", Order = 62)]
        public virtual ICollection<AuthCredentialsHistory2> AuthCredentialsHistory2s { get; set; }

        [Display(Name = "Auth Credentials Historys 1", Order = 63)]
        public virtual ICollection<AuthCredentialsHistory2> AuthCredentialsHistory2s1 { get; set; }

        [Display(Name = "Auth Credentials Historys 2", Order = 64)]
        public virtual ICollection<AuthCredentialsHistory2> AuthCredentialsHistory2s2 { get; set; }

        [Display(Name = "Batch Groups", Order = 65)]
        public virtual ICollection<BatchGroup2> BatchGroup2s { get; set; }

        [Display(Name = "Batch Groups 1", Order = 66)]
        public virtual ICollection<BatchGroup2> BatchGroup2s1 { get; set; }

        [Display(Name = "Blocks", Order = 67)]
        public virtual ICollection<Block2> Block2s { get; set; }

        [Display(Name = "Blocks 1", Order = 68)]
        public virtual ICollection<Block2> Block2s1 { get; set; }

        [Display(Name = "Blocks 2", Order = 69)]
        public virtual ICollection<Block2> Block2s2 { get; set; }

        [Display(Name = "Block Conditions", Order = 70)]
        public virtual ICollection<BlockCondition2> BlockCondition2s { get; set; }

        [Display(Name = "Block Conditions 1", Order = 71)]
        public virtual ICollection<BlockCondition2> BlockCondition2s1 { get; set; }

        [Display(Name = "Block Limits", Order = 72)]
        public virtual ICollection<BlockLimit2> BlockLimit2s { get; set; }

        [Display(Name = "Block Limits 1", Order = 73)]
        public virtual ICollection<BlockLimit2> BlockLimit2s1 { get; set; }

        [Display(Name = "Bound With Parts", Order = 74)]
        public virtual ICollection<BoundWithPart2> BoundWithPart2s { get; set; }

        [Display(Name = "Bound With Parts 1", Order = 75)]
        public virtual ICollection<BoundWithPart2> BoundWithPart2s1 { get; set; }

        [Display(Name = "Budgets", Order = 76)]
        public virtual ICollection<Budget2> Budget2s { get; set; }

        [Display(Name = "Budgets 1", Order = 77)]
        public virtual ICollection<Budget2> Budget2s1 { get; set; }

        [Display(Name = "Call Number Types", Order = 78)]
        public virtual ICollection<CallNumberType2> CallNumberType2s { get; set; }

        [Display(Name = "Call Number Types 1", Order = 79)]
        public virtual ICollection<CallNumberType2> CallNumberType2s1 { get; set; }

        [Display(Name = "Campuss", Order = 80)]
        public virtual ICollection<Campus2> Campus2s { get; set; }

        [Display(Name = "Campuss 1", Order = 81)]
        public virtual ICollection<Campus2> Campus2s1 { get; set; }

        [Display(Name = "Cancellation Reasons", Order = 82)]
        public virtual ICollection<CancellationReason2> CancellationReason2s { get; set; }

        [Display(Name = "Cancellation Reasons 1", Order = 83)]
        public virtual ICollection<CancellationReason2> CancellationReason2s1 { get; set; }

        [Display(Name = "Categorys", Order = 84)]
        public virtual ICollection<Category2> Category2s { get; set; }

        [Display(Name = "Categorys 1", Order = 85)]
        public virtual ICollection<Category2> Category2s1 { get; set; }

        [Display(Name = "Check Ins", Order = 86)]
        public virtual ICollection<CheckIn2> CheckIn2s { get; set; }

        [Display(Name = "Circulation Rules", Order = 87)]
        public virtual ICollection<CirculationRule2> CirculationRule2s { get; set; }

        [Display(Name = "Circulation Rules 1", Order = 88)]
        public virtual ICollection<CirculationRule2> CirculationRule2s1 { get; set; }

        [Display(Name = "Classification Types", Order = 89)]
        public virtual ICollection<ClassificationType2> ClassificationType2s { get; set; }

        [Display(Name = "Classification Types 1", Order = 90)]
        public virtual ICollection<ClassificationType2> ClassificationType2s1 { get; set; }

        [Display(Name = "Comments", Order = 91)]
        public virtual ICollection<Comment2> Comment2s { get; set; }

        [Display(Name = "Comments 1", Order = 92)]
        public virtual ICollection<Comment2> Comment2s1 { get; set; }

        [Display(Name = "Configurations", Order = 93)]
        public virtual ICollection<Configuration2> Configuration2s { get; set; }

        [Display(Name = "Configurations 1", Order = 94)]
        public virtual ICollection<Configuration2> Configuration2s1 { get; set; }

        [Display(Name = "Contacts", Order = 95)]
        public virtual ICollection<Contact2> Contact2s { get; set; }

        [Display(Name = "Contacts 1", Order = 96)]
        public virtual ICollection<Contact2> Contact2s1 { get; set; }

        [Display(Name = "Contact Addresses", Order = 97)]
        public virtual ICollection<ContactAddress> ContactAddresses { get; set; }

        [Display(Name = "Contact Addresses 1", Order = 98)]
        public virtual ICollection<ContactAddress> ContactAddresses1 { get; set; }

        [Display(Name = "Contact Emails", Order = 99)]
        public virtual ICollection<ContactEmail> ContactEmails { get; set; }

        [Display(Name = "Contact Emails 1", Order = 100)]
        public virtual ICollection<ContactEmail> ContactEmails1 { get; set; }

        [Display(Name = "Contact Phone Numbers", Order = 101)]
        public virtual ICollection<ContactPhoneNumber> ContactPhoneNumbers { get; set; }

        [Display(Name = "Contact Phone Numbers 1", Order = 102)]
        public virtual ICollection<ContactPhoneNumber> ContactPhoneNumbers1 { get; set; }

        [Display(Name = "Contact URLs", Order = 103)]
        public virtual ICollection<ContactUrl> ContactUrls { get; set; }

        [Display(Name = "Contact URLs 1", Order = 104)]
        public virtual ICollection<ContactUrl> ContactUrls1 { get; set; }

        [Display(Name = "Contributor Name Types", Order = 105)]
        public virtual ICollection<ContributorNameType2> ContributorNameType2s { get; set; }

        [Display(Name = "Contributor Name Types 1", Order = 106)]
        public virtual ICollection<ContributorNameType2> ContributorNameType2s1 { get; set; }

        [Display(Name = "Contributor Types", Order = 107)]
        public virtual ICollection<ContributorType2> ContributorType2s { get; set; }

        [Display(Name = "Contributor Types 1", Order = 108)]
        public virtual ICollection<ContributorType2> ContributorType2s1 { get; set; }

        [Display(Name = "Custom Fields", Order = 109)]
        public virtual ICollection<CustomField2> CustomField2s { get; set; }

        [Display(Name = "Custom Fields 1", Order = 110)]
        public virtual ICollection<CustomField2> CustomField2s1 { get; set; }

        [Display(Name = "Departments", Order = 111)]
        public virtual ICollection<Department2> Department2s { get; set; }

        [Display(Name = "Departments 1", Order = 112)]
