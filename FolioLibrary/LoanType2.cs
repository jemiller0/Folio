...
namespace FolioLibrary
{
    ...
    public partial class LoanType2
    {
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("LoanType2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("LoanType2s1")]
        ...
        [Column("content"), CustomValidation(typeof(LoanType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 12), Editable(false)]
