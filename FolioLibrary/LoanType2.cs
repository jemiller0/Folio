...
namespace FolioLibrary
{
    ...
    public partial class LoanType2
    {
        ...
        {
            using (var sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.LoanType.json")))
            {
        ...
        [Display(Name = "Creation User", Order = 4), InverseProperty("LoanType2s")]
        ...
        [Display(Name = "Last Write User", Order = 8), InverseProperty("LoanType2s1")]
        ...
        [Column("content"), CustomValidation(typeof(LoanType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 11), Editable(false)]
        public virtual string Content { get; set; }

        [Display(Name = "Items", Order = 12)]
        public virtual ICollection<Item2> Item2s { get; set; }

        [Display(Name = "Items 1", Order = 13)]
        ...
        public static LoanType2 FromJObject(JObject jObject) => jObject != null ? new LoanType2
        {
