...
namespace FolioLibrary
{
    ...
    public partial class LedgerRolloverError
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(LedgerRolloverError), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static LedgerRolloverError FromJObject(JObject jObject) => jObject != null ? new LedgerRolloverError
        {
