...
namespace FolioLibrary
{
    ...
    public partial class Suffix2
    {
        ...
        {
            using (var sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Suffix.json")))
            {
        ...
        [Column("content"), CustomValidation(typeof(Suffix), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 4), Editable(false)]
        ...
        public static Suffix2 FromJObject(JObject jObject) => jObject != null ? new Suffix2
        {
