...
{
    [Table("loan", Schema = "diku_mod_circulation_storage")]
    public partial class Loan
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Loan.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Loan), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
