...
{
    // uc.permissions_users -> uchicago_mod_permissions.permissions_users
    ...
    public partial class PermissionsUser2
    {
        ...
        public static PermissionsUser2 FromJObject(JObject jObject) => jObject != null ? new PermissionsUser2
        {
            ...
            PermissionsUserPermissions = jObject.SelectToken("permissions")?.Select(jt => PermissionsUserPermission.FromJObject((JValue)jt)).ToArray()
        } : null;
