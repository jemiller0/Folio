...
namespace FolioLibrary
{
    ...
    public partial class ExpenseClass2
    {
        ...
        [Column("external_account_number_ext"), Display(Name = "External Account Number Ext", Order = 3), JsonProperty("externalAccountNumberExt"), StringLength(1024)]
        public virtual string ExternalAccountNumberExt { get; set; }
        ...
        public override string ToString() => $"{{ {nameof(Id)} = {Id}, {nameof(Code)} = {Code}, {nameof(ExternalAccountNumberExt)} = {ExternalAccountNumberExt}, {nameof(Name)} = {Name}, {nameof(CreationTime)} = {CreationTime}, {nameof(CreationUserId)} = {CreationUserId}, {nameof(CreationUserUsername)} = {CreationUserUsername}, {nameof(LastWriteTime)} = {LastWriteTime}, {nameof(LastWriteUserId)} = {LastWriteUserId}, {nameof(LastWriteUserUsername)} = {LastWriteUserUsername}, {nameof(Content)} = {Content} }}";
        ...
        public static ExpenseClass2 FromJObject(JObject jObject) => jObject != null ? new ExpenseClass2
        {
            ...
            ExternalAccountNumberExt = (string)jObject.SelectToken("externalAccountNumberExt"),
        ...
        public JObject ToJObject() => new JObject(
            ...
            new JProperty("externalAccountNumberExt", ExternalAccountNumberExt),
