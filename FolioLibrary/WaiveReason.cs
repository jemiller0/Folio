...
namespace FolioLibrary
{
    ...
    public partial class WaiveReason
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(WaiveReason), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static WaiveReason FromJObject(JObject jObject) => jObject != null ? new WaiveReason
        {
