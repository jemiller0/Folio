...
namespace FolioLibrary
{
    ...
    public partial class BatchGroup2
    {
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("BatchGroup2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("BatchGroup2s1")]
        ...
        public static BatchGroup2 FromJObject(JObject jObject) => jObject != null ? new BatchGroup2
        {
