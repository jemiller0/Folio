...
{
    // uc.owners -> uchicago_mod_feesfines.owners
    // Owner2 -> Owner
    ...
    public partial class Owner2
    {
        ...
        public static Owner2 FromJObject(JObject jObject) => jObject != null ? new Owner2
        {
            ...
            ServicePointOwners = jObject.SelectToken("servicePointOwner")?.Where(jt => jt.HasValues).Select(jt => ServicePointOwner.FromJObject((JObject)jt)).ToArray()
        } : null;
