...
namespace FolioLibrary
{
    ...
    public partial class NatureOfContentTerm2
    {
        ...
        {
            using (var sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.NatureOfContentTerm.json")))
            {
        ...
        [Display(Name = "Creation User", Order = 5), InverseProperty("NatureOfContentTerm2s")]
        ...
        [Display(Name = "Last Write User", Order = 9), InverseProperty("NatureOfContentTerm2s1")]
        ...
        [Column("content"), CustomValidation(typeof(NatureOfContentTerm), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 12), Editable(false)]
        public virtual string Content { get; set; }

        [Display(Name = "Instance Nature Of Content Terms", Order = 13)]
        ...
        public static NatureOfContentTerm2 FromJObject(JObject jObject) => jObject != null ? new NatureOfContentTerm2
        {
