...
{
    [Table("event_logs", Schema = "diku_mod_login")]
    public partial class EventLog
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.EventLog.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(EventLog), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
