...
{
    [Table("instance_relationship_type", Schema = "uchicago_mod_inventory_storage")]
    public partial class InstanceRelationshipType
    {
        ...
        public static InstanceRelationshipType FromJObject(JObject jObject) => jObject != null ? new InstanceRelationshipType
        {
