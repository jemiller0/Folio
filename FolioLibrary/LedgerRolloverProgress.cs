...
{
    [Table("ledger_fiscal_year_rollover_progress", Schema = "uchicago_mod_finance_storage")]
    public partial class LedgerRolloverProgress
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(LedgerRolloverProgress), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static LedgerRolloverProgress FromJObject(JObject jObject) => jObject != null ? new LedgerRolloverProgress
        {
