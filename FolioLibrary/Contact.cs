...
{
    [Table("contact", Schema = "diku_mod_vendors")]
    public partial class Contact
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Contact.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Contact), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
