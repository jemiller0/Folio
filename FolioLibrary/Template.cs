...
{
    [Table("template", Schema = "uchicago_mod_template_engine")]
    public partial class Template
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(Template), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static Template FromJObject(JObject jObject) => jObject != null ? new Template
        {
