...
{
    [Table("refunds", Schema = "uchicago_mod_feesfines")]
    public partial class RefundReason
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(RefundReason), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static RefundReason FromJObject(JObject jObject) => jObject != null ? new RefundReason
        {
