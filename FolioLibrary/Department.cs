...
{
    [Table("departments", Schema = "uchicago_mod_users")]
    public partial class Department
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(Department), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static Department FromJObject(JObject jObject) => jObject != null ? new Department
        {
