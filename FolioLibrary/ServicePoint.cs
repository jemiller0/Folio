...
{
    [Table("service_point", Schema = "diku_mod_inventory_storage")]
    public partial class ServicePoint
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.ServicePoint.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(ServicePoint), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public virtual ICollection<ServicePointUser> ServicePointUsers { get; set; }
