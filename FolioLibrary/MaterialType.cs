...
{
    [Table("material_type", Schema = "uchicago_mod_inventory_storage")]
    public partial class MaterialType
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(MaterialType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static MaterialType FromJObject(JObject jObject) => jObject != null ? new MaterialType
        {
