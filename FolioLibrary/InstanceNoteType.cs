...
{
    [Table("instance_note_type", Schema = "uchicago_mod_inventory_storage")]
    public partial class InstanceNoteType
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(InstanceNoteType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static InstanceNoteType FromJObject(JObject jObject) => jObject != null ? new InstanceNoteType
        {
