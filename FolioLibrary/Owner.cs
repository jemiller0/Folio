...
{
    [Table("owners", Schema = "diku_mod_feesfines")]
    public partial class Owner
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Owner.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Owner), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
