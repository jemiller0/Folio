...
{
    [Table("patron_action_session", Schema = "uchicago_mod_circulation_storage")]
    public partial class PatronActionSession
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(PatronActionSession), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static PatronActionSession FromJObject(JObject jObject) => jObject != null ? new PatronActionSession
        {
