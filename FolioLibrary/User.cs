...
{
    [Table("users", Schema = "diku_mod_users")]
    public partial class User
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.User.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(User), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
