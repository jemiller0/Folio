...
namespace FolioLibrary
{
    ...
    public partial class OrderItem2
    {
        ...
        public static OrderItem2 FromJObject(JObject jObject) => jObject != null ? new OrderItem2
        {
            ...
            EresourceExpectedActivationDate = (DateTime?)jObject.SelectToken("eresource.expectedActivation"),
            ...
            PhysicalExpectedReceiptDate = (DateTime?)jObject.SelectToken("physical.expectedReceiptDate"),
            ...
            ReceiptDate = (DateTime?)jObject.SelectToken("receiptDate"),
        ...
        public JObject ToJObject() => new JObject(
            ...
            new JProperty("eresource", new JObject(
                ...
                new JProperty("expectedActivation", EresourceExpectedActivationDate),
            ...
            new JProperty("physical", new JObject(
                ...
                new JProperty("expectedReceiptDate", PhysicalExpectedReceiptDate),
                new JProperty("receiptDue", PhysicalReceiptDue),
            ...
            new JProperty("receiptDate", ReceiptDate),
