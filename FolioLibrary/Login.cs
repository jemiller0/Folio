...
{
    [Table("auth_credentials", Schema = "diku_mod_login")]
    public partial class Login
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Login.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Login), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
