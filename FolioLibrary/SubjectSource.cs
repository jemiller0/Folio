...
{
    [Table("subject_source", Schema = "uchicago_mod_inventory_storage")]
    public partial class SubjectSource
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(SubjectSource), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static SubjectSource FromJObject(JObject jObject) => jObject != null ? new SubjectSource
        {
