...
namespace FolioLibrary
{
    public class FolioDapperContext : IDisposable
    {
        ...
        {
            var bg = Query<BudgetGroup>($"SELECT id AS \"Id\", jsonb AS \"Content\", budgetid AS \"Budgetid\", groupid AS \"Groupid\", fundid AS \"Fundid\", fiscalyearid AS \"Fiscalyearid\" FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}group_fund_fiscal_year WHERE id = @id", new { id }).SingleOrDefault();
        ...
        {
            var jm = Query<JobMonitoring>($"SELECT id AS \"Id\", job_execution_id AS \"JobExecutionId\", last_event_timestamp AS \"LastEventTimestamp\", notification_sent AS \"NotificationSent\" FROM diku_mod_source_record_manager{(IsMySql ? "_" : ".")}job_monitoring WHERE id = @id", new { id }).SingleOrDefault();
        ...
        {
            var jr = Query<JournalRecord>($"SELECT id AS \"Id\", job_execution_id AS \"JobExecutionId\", source_id AS \"SourceId\", entity_type AS \"EntityType\", entity_id AS \"EntityId\", entity_hrid AS \"EntityHrid\", action_type AS \"ActionType\", action_status AS \"ActionStatus\", action_date AS \"ActionDate\", source_record_order AS \"SourceRecordOrder\", error AS \"Error\", title AS \"Title\" FROM diku_mod_source_record_manager{(IsMySql ? "_" : ".")}journal_records WHERE id = @id", new { id }).SingleOrDefault();
        ...
        {
            var lr = Query<LedgerRollover>($"SELECT id AS \"Id\", jsonb AS \"Content\", creation_date AS \"CreationTime\", created_by AS \"CreationUserId\", ledgerid AS \"Ledgerid\", fromfiscalyearid AS \"Fromfiscalyearid\", tofiscalyearid AS \"Tofiscalyearid\" FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover WHERE id = @id", new { id }).SingleOrDefault();
        ...
        {
            var lre = Query<LedgerRolloverError>($"SELECT id AS \"Id\", jsonb AS \"Content\", creation_date AS \"CreationTime\", created_by AS \"CreationUserId\", ledgerrolloverid AS \"Ledgerrolloverid\" FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover_error WHERE id = @id", new { id }).SingleOrDefault();
        ...
        {
            var lrp = Query<LedgerRolloverProgress>($"SELECT id AS \"Id\", jsonb AS \"Content\", creation_date AS \"CreationTime\", created_by AS \"CreationUserId\", ledgerrolloverid AS \"Ledgerrolloverid\" FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover_progress WHERE id = @id", new { id }).SingleOrDefault();
        ...
        public LoanEvent FindLoanEvent(Guid? id, bool load = false) => Query<LoanEvent>($"SELECT id AS \"Id\", jsonb AS \"Content\" FROM diku_mod_circulation_storage{(IsMySql ? "_" : ".")}audit_loan WHERE id = @id", new { id }).SingleOrDefault();
        ...
        public ManualBlockTemplate FindManualBlockTemplate(Guid? id, bool load = false) => Query<ManualBlockTemplate>($"SELECT id AS \"Id\", jsonb AS \"Content\", creation_date AS \"CreationTime\", created_by AS \"CreationUserId\" FROM diku_mod_feesfines{(IsMySql ? "_" : ".")}manual_block_templates WHERE id = @id", new { id }).SingleOrDefault();
        ...
        {
            var n = Query<Note>($"SELECT id AS \"Id\", jsonb AS \"Content\", temporary_type_id AS \"TemporaryTypeId\", search_content AS \"SearchContent\" FROM diku_mod_notes{(IsMySql ? "_" : ".")}note_data WHERE id = @id", new { id }).SingleOrDefault();
        ...
        {
            var p2 = Query<Payment2>($"SELECT id AS \"Id\", date_action AS \"CreationTime\", type_action AS \"TypeAction\", comments AS \"Comments\", notify AS \"Notify\", amount_action AS \"Amount\", balance AS \"RemainingAmount\", transaction_information AS \"TransactionInformation\", service_point_id AS \"ServicePointId\", source AS \"Source\", payment_method AS \"PaymentMethod\", fee_id AS \"FeeId\", user_id AS \"UserId\", content AS \"Content\" FROM uc{(IsMySql ? "_" : ".")}payments WHERE id = @id", new { id }).SingleOrDefault();
            if (p2 == null) return null;
            if (load && p2.ServicePointId != null) p2.ServicePoint = FindServicePoint2(p2.ServicePointId);
        ...
        public IEnumerable<BudgetGroup> BudgetGroups(string where = null, object param = null, string orderBy = null, int? skip = null, int? take = null) => Query<BudgetGroup>($"SELECT id AS \"Id\", jsonb AS \"Content\", budgetid AS \"Budgetid\", groupid AS \"Groupid\", fundid AS \"Fundid\", fiscalyearid AS \"Fiscalyearid\" FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}group_fund_fiscal_year{(where != null ? $" WHERE {where}" : "")}{(orderBy != null || skip != null || take != null ? $" ORDER BY {orderBy ?? "id"}" : "")}", param, skip, take);
        ...
        public IEnumerable<Instance2> Instance2s(string where = null, object param = null, string orderBy = null, int? skip = null, int? take = null) => Query<Instance2>($"SELECT id AS \"Id\", _version AS \"Version\", hrid AS \"ShortId\", match_key AS \"MatchKey\", source AS \"Source\", title AS \"Title\", author AS \"Author\", publication_year AS \"PublicationYear\", index_title AS \"IndexTitle\", instance_type_id AS \"InstanceTypeId\", mode_of_issuance_id AS \"IssuanceModeId\", cataloged_date AS \"CatalogedDate\", previously_held AS \"PreviouslyHeld\", staff_suppress AS \"StaffSuppress\", discovery_suppress AS \"DiscoverySuppress\", source_record_format AS \"SourceRecordFormat\", status_id AS \"StatusId\", status_updated_date AS \"StatusLastWriteTime\", created_date AS \"CreationTime\", created_by_user_id AS \"CreationUserId\", created_by_username AS \"CreationUserUsername\", updated_date AS \"LastWriteTime\", updated_by_user_id AS \"LastWriteUserId\", updated_by_username AS \"LastWriteUserUsername\", content AS \"Content\" FROM uc{(IsMySql ? "_" : ".")}instances{(where != null ? $" WHERE {where}" : "")}{(orderBy != null || skip != null || take != null ? $" ORDER BY {orderBy ?? "id"}" : "")}", param, skip, take);
        ...
        public IEnumerable<JobMonitoring> JobMonitorings(string where = null, object param = null, string orderBy = null, int? skip = null, int? take = null) => Query<JobMonitoring>($"SELECT id AS \"Id\", job_execution_id AS \"JobExecutionId\", last_event_timestamp AS \"LastEventTimestamp\", notification_sent AS \"NotificationSent\" FROM diku_mod_source_record_manager{(IsMySql ? "_" : ".")}job_monitoring{(where != null ? $" WHERE {where}" : "")}{(orderBy != null || skip != null || take != null ? $" ORDER BY {orderBy ?? "id"}" : "")}", param, skip, take);
        public IEnumerable<JournalRecord> JournalRecords(string where = null, object param = null, string orderBy = null, int? skip = null, int? take = null) => Query<JournalRecord>($"SELECT id AS \"Id\", job_execution_id AS \"JobExecutionId\", source_id AS \"SourceId\", entity_type AS \"EntityType\", entity_id AS \"EntityId\", entity_hrid AS \"EntityHrid\", action_type AS \"ActionType\", action_status AS \"ActionStatus\", action_date AS \"ActionDate\", source_record_order AS \"SourceRecordOrder\", error AS \"Error\", title AS \"Title\" FROM diku_mod_source_record_manager{(IsMySql ? "_" : ".")}journal_records{(where != null ? $" WHERE {where}" : "")}{(orderBy != null || skip != null || take != null ? $" ORDER BY {orderBy ?? "id"}" : "")}", param, skip, take);
        ...
        public IEnumerable<LedgerRollover> LedgerRollovers(string where = null, object param = null, string orderBy = null, int? skip = null, int? take = null) => Query<LedgerRollover>($"SELECT id AS \"Id\", jsonb AS \"Content\", creation_date AS \"CreationTime\", created_by AS \"CreationUserId\", ledgerid AS \"Ledgerid\", fromfiscalyearid AS \"Fromfiscalyearid\", tofiscalyearid AS \"Tofiscalyearid\" FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover{(where != null ? $" WHERE {where}" : "")}{(orderBy != null || skip != null || take != null ? $" ORDER BY {orderBy ?? "id"}" : "")}", param, skip, take);
        ...
        public IEnumerable<LedgerRolloverError> LedgerRolloverErrors(string where = null, object param = null, string orderBy = null, int? skip = null, int? take = null) => Query<LedgerRolloverError>($"SELECT id AS \"Id\", jsonb AS \"Content\", creation_date AS \"CreationTime\", created_by AS \"CreationUserId\", ledgerrolloverid AS \"Ledgerrolloverid\" FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover_error{(where != null ? $" WHERE {where}" : "")}{(orderBy != null || skip != null || take != null ? $" ORDER BY {orderBy ?? "id"}" : "")}", param, skip, take);
        ...
        public IEnumerable<LoanEvent> LoanEvents(string where = null, object param = null, string orderBy = null, int? skip = null, int? take = null) => Query<LoanEvent>($"SELECT id AS \"Id\", jsonb AS \"Content\" FROM diku_mod_circulation_storage{(IsMySql ? "_" : ".")}audit_loan{(where != null ? $" WHERE {where}" : "")}{(orderBy != null || skip != null || take != null ? $" ORDER BY {orderBy ?? "id"}" : "")}", param, skip, take);
        ...
        public IEnumerable<ManualBlockTemplate> ManualBlockTemplates(string where = null, object param = null, string orderBy = null, int? skip = null, int? take = null) => Query<ManualBlockTemplate>($"SELECT id AS \"Id\", jsonb AS \"Content\", creation_date AS \"CreationTime\", created_by AS \"CreationUserId\" FROM diku_mod_feesfines{(IsMySql ? "_" : ".")}manual_block_templates{(where != null ? $" WHERE {where}" : "")}{(orderBy != null || skip != null || take != null ? $" ORDER BY {orderBy ?? "id"}" : "")}", param, skip, take);
        ...
        public IEnumerable<Note> Notes(string where = null, object param = null, string orderBy = null, int? skip = null, int? take = null) => Query<Note>($"SELECT id AS \"Id\", jsonb AS \"Content\", temporary_type_id AS \"TemporaryTypeId\", search_content AS \"SearchContent\" FROM diku_mod_notes{(IsMySql ? "_" : ".")}note_data{(where != null ? $" WHERE {where}" : "")}{(orderBy != null || skip != null || take != null ? $" ORDER BY {orderBy ?? "id"}" : "")}", param, skip, take);
        ...
        public int CountBudgetGroups(string where = null, object param = null, int? take = null) => Count($"SELECT 1 FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}group_fund_fiscal_year{(where != null ? $" WHERE {where}" : "")}", param: param, take: take);
        ...
        public int CountJobMonitorings(string where = null, object param = null, int? take = null) => Count($"SELECT 1 FROM diku_mod_source_record_manager{(IsMySql ? "_" : ".")}job_monitoring{(where != null ? $" WHERE {where}" : "")}", param: param, take: take);
        ...
        public int CountLedgerRollovers(string where = null, object param = null, int? take = null) => Count($"SELECT 1 FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover{(where != null ? $" WHERE {where}" : "")}", param: param, take: take);
        ...
        public int CountLedgerRolloverErrors(string where = null, object param = null, int? take = null) => Count($"SELECT 1 FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover_error{(where != null ? $" WHERE {where}" : "")}", param: param, take: take);
        ...
        public int CountLedgerRolloverProgresses(string where = null, object param = null, int? take = null) => Count($"SELECT 1 FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover_progress{(where != null ? $" WHERE {where}" : "")}", param: param, take: take);
        ...
        public int CountLoanEvents(string where = null, object param = null, int? take = null) => Count($"SELECT 1 FROM diku_mod_circulation_storage{(IsMySql ? "_" : ".")}audit_loan{(where != null ? $" WHERE {where}" : "")}", param: param, take: take);
        ...
        public int CountManualBlockTemplates(string where = null, object param = null, int? take = null) => Count($"SELECT 1 FROM diku_mod_feesfines{(IsMySql ? "_" : ".")}manual_block_templates{(where != null ? $" WHERE {where}" : "")}", param: param, take: take);
        ...
        public bool AnyBudgetGroups(string where = null, object param = null) => Query($"SELECT 1 FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}group_fund_fiscal_year{(where != null ? $" WHERE {where}" : "")}{(IsSqlServer ? $" ORDER BY id" : "")}", param: param, take: 1).Any();
        ...
        public bool AnyJobMonitorings(string where = null, object param = null) => Query($"SELECT 1 FROM diku_mod_source_record_manager{(IsMySql ? "_" : ".")}job_monitoring{(where != null ? $" WHERE {where}" : "")}{(IsSqlServer ? $" ORDER BY id" : "")}", param: param, take: 1).Any();
        ...
        public bool AnyLedgerRollovers(string where = null, object param = null) => Query($"SELECT 1 FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover{(where != null ? $" WHERE {where}" : "")}{(IsSqlServer ? $" ORDER BY id" : "")}", param: param, take: 1).Any();
        ...
        public bool AnyLedgerRolloverErrors(string where = null, object param = null) => Query($"SELECT 1 FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover_error{(where != null ? $" WHERE {where}" : "")}{(IsSqlServer ? $" ORDER BY id" : "")}", param: param, take: 1).Any();
        ...
        public bool AnyLedgerRolloverProgresses(string where = null, object param = null) => Query($"SELECT 1 FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover_progress{(where != null ? $" WHERE {where}" : "")}{(IsSqlServer ? $" ORDER BY id" : "")}", param: param, take: 1).Any();
        ...
        public bool AnyLoanEvents(string where = null, object param = null) => Query($"SELECT 1 FROM diku_mod_circulation_storage{(IsMySql ? "_" : ".")}audit_loan{(where != null ? $" WHERE {where}" : "")}{(IsSqlServer ? $" ORDER BY id" : "")}", param: param, take: 1).Any();
        ...
        public bool AnyManualBlockTemplates(string where = null, object param = null) => Query($"SELECT 1 FROM diku_mod_feesfines{(IsMySql ? "_" : ".")}manual_block_templates{(where != null ? $" WHERE {where}" : "")}{(IsSqlServer ? $" ORDER BY id" : "")}", param: param, take: 1).Any();
        ...
        public void Insert(BudgetGroup budgetGroup) => Execute("INSERT INTO diku_mod_finance_storage.group_fund_fiscal_year (id, jsonb, budgetid, groupid, fundid, fiscalyearid) VALUES (@Id, @Content::jsonb, @Budgetid, @Groupid, @Fundid, @Fiscalyearid)", budgetGroup);
        ...
        public void Insert(JobMonitoring jobMonitoring) => Execute("INSERT INTO diku_mod_source_record_manager.job_monitoring (id, job_execution_id, last_event_timestamp, notification_sent) VALUES (@Id, @JobExecutionId, @LastEventTimestamp, @NotificationSent)", jobMonitoring);
        public void Insert(JournalRecord journalRecord) => Execute("INSERT INTO diku_mod_source_record_manager.journal_records (id, job_execution_id, source_id, entity_type, entity_id, entity_hrid, action_type, action_status, action_date, source_record_order, error, title) VALUES (@Id, @JobExecutionId, @SourceId, @EntityType, @EntityId, @EntityHrid, @ActionType, @ActionStatus, @ActionDate, @SourceRecordOrder, @Error, @Title)", journalRecord);
        ...
        public void Insert(LedgerRollover ledgerRollover) => Execute("INSERT INTO diku_mod_finance_storage.ledger_fiscal_year_rollover (id, jsonb, creation_date, created_by, ledgerid, fromfiscalyearid, tofiscalyearid) VALUES (@Id, @Content::jsonb, @CreationTime, @CreationUserId, @Ledgerid, @Fromfiscalyearid, @Tofiscalyearid)", ledgerRollover);
        public void Insert(LedgerRolloverError ledgerRolloverError) => Execute("INSERT INTO diku_mod_finance_storage.ledger_fiscal_year_rollover_error (id, jsonb, creation_date, created_by, ledgerrolloverid) VALUES (@Id, @Content::jsonb, @CreationTime, @CreationUserId, @Ledgerrolloverid)", ledgerRolloverError);
        public void Insert(LedgerRolloverProgress ledgerRolloverProgress) => Execute("INSERT INTO diku_mod_finance_storage.ledger_fiscal_year_rollover_progress (id, jsonb, creation_date, created_by, ledgerrolloverid) VALUES (@Id, @Content::jsonb, @CreationTime, @CreationUserId, @Ledgerrolloverid)", ledgerRolloverProgress);
        ...
        public void Insert(LoanEvent loanEvent) => Execute("INSERT INTO diku_mod_circulation_storage.audit_loan (id, jsonb) VALUES (@Id, @Content::jsonb)", loanEvent);
        ...
        public void Insert(ManualBlockTemplate manualBlockTemplate) => Execute("INSERT INTO diku_mod_feesfines.manual_block_templates (id, jsonb, creation_date, created_by) VALUES (@Id, @Content::jsonb, @CreationTime, @CreationUserId)", manualBlockTemplate);
        ...
        public void Insert(Note note) => Execute("INSERT INTO diku_mod_notes.note_data (id, jsonb, temporary_type_id, search_content) VALUES (@Id, @Content::jsonb, @TemporaryTypeId, @SearchContent)", note);
        ...
        public int Update(BudgetGroup budgetGroup) => Execute($"UPDATE diku_mod_finance_storage.group_fund_fiscal_year SET jsonb = @Content::jsonb, budgetid = @Budgetid, groupid = @Groupid, fundid = @Fundid, fiscalyearid = @Fiscalyearid WHERE id = @Id", budgetGroup);
        ...
        public int Update(JobMonitoring jobMonitoring) => Execute($"UPDATE diku_mod_source_record_manager.job_monitoring SET job_execution_id = @JobExecutionId, last_event_timestamp = @LastEventTimestamp, notification_sent = @NotificationSent WHERE id = @Id", jobMonitoring);
        ...
        public int Update(LedgerRollover ledgerRollover) => Execute($"UPDATE diku_mod_finance_storage.ledger_fiscal_year_rollover SET jsonb = @Content::jsonb, creation_date = @CreationTime, created_by = @CreationUserId, ledgerid = @Ledgerid, fromfiscalyearid = @Fromfiscalyearid, tofiscalyearid = @Tofiscalyearid WHERE id = @Id", ledgerRollover);
        public int Update(LedgerRolloverError ledgerRolloverError) => Execute($"UPDATE diku_mod_finance_storage.ledger_fiscal_year_rollover_error SET jsonb = @Content::jsonb, creation_date = @CreationTime, created_by = @CreationUserId, ledgerrolloverid = @Ledgerrolloverid WHERE id = @Id", ledgerRolloverError);
        public int Update(LedgerRolloverProgress ledgerRolloverProgress) => Execute($"UPDATE diku_mod_finance_storage.ledger_fiscal_year_rollover_progress SET jsonb = @Content::jsonb, creation_date = @CreationTime, created_by = @CreationUserId, ledgerrolloverid = @Ledgerrolloverid WHERE id = @Id", ledgerRolloverProgress);
        ...
        public int Update(LoanEvent loanEvent) => Execute($"UPDATE diku_mod_circulation_storage.audit_loan SET jsonb = @Content::jsonb WHERE id = @Id", loanEvent);
        ...
        public int Update(ManualBlockTemplate manualBlockTemplate) => Execute($"UPDATE diku_mod_feesfines.manual_block_templates SET jsonb = @Content::jsonb, creation_date = @CreationTime, created_by = @CreationUserId WHERE id = @Id", manualBlockTemplate);
        ...
        public int Update(Note note) => Execute($"UPDATE diku_mod_notes.note_data SET jsonb = @Content::jsonb, temporary_type_id = @TemporaryTypeId, search_content = @SearchContent WHERE id = @Id", note);
        ...
        public int DeleteBudgetGroup(Guid? id) => Execute($"DELETE FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}group_fund_fiscal_year WHERE id = @id", new { id });
        ...
        public int DeleteJobMonitoring(Guid? id) => Execute($"DELETE FROM diku_mod_source_record_manager{(IsMySql ? "_" : ".")}job_monitoring WHERE id = @id", new { id });
        ...
        public int DeleteLedgerRollover(Guid? id) => Execute($"DELETE FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover WHERE id = @id", new { id });
        ...
        public int DeleteLedgerRolloverError(Guid? id) => Execute($"DELETE FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover_error WHERE id = @id", new { id });
        public int DeleteLedgerRolloverError2(Guid? id) => Execute($"DELETE FROM uc{(IsMySql ? "_" : ".")}ledger_rollover_errors WHERE id = @id", new { id });
        public int DeleteLedgerRolloverProgress(Guid? id) => Execute($"DELETE FROM diku_mod_finance_storage{(IsMySql ? "_" : ".")}ledger_fiscal_year_rollover_progress WHERE id = @id", new { id });
        ...
        public int DeleteLoanEvent(Guid? id) => Execute($"DELETE FROM diku_mod_circulation_storage{(IsMySql ? "_" : ".")}audit_loan WHERE id = @id", new { id });
        ...
        public int DeleteManualBlockTemplate(Guid? id) => Execute($"DELETE FROM diku_mod_feesfines{(IsMySql ? "_" : ".")}manual_block_templates WHERE id = @id", new { id });
