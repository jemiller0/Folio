...
{
    // uc.orders -> uchicago_mod_orders_storage.purchase_order
    // Order2 -> Order
    ...
    public partial class Order2
    {
        ...
        public static Order2 FromJObject(JObject jObject) => jObject != null ? new Order2
        {
            ...
            OngoingRenewalDate = ((DateTime?)jObject.SelectToken("ongoing.renewalDate"))?.ToUniversalTime(),
            OngoingReviewDate = ((DateTime?)jObject.SelectToken("ongoing.reviewDate"))?.ToUniversalTime(),
        ...
        public JObject ToJObject() => new JObject(
            ...
            new JProperty("ongoing", new JObject(
                ...
                new JProperty("renewalDate", OngoingRenewalDate?.ToLocalTime()),
                new JProperty("reviewDate", OngoingReviewDate?.ToLocalTime()))),
