...
namespace FolioLibrary
{
    ...
    public partial class Order2
    {
        ...
        public static Order2 FromJObject(JObject jObject) => jObject != null ? new Order2
        {
            ...
            OrderDate = ((DateTime?)jObject.SelectToken("dateOrdered"))?.ToLocalTime(),
            ...
            OngoingRenewalDate = ((DateTime?)jObject.SelectToken("ongoing.renewalDate"))?.ToLocalTime(),
            OngoingReviewDate = ((DateTime?)jObject.SelectToken("ongoing.reviewDate"))?.ToLocalTime(),
        ...
        public JObject ToJObject() => new JObject(
            ...
            new JProperty("dateOrdered", OrderDate?.ToUniversalTime()),
            ...
            new JProperty("ongoing", new JObject(
                ...
                new JProperty("renewalDate", OngoingRenewalDate?.ToUniversalTime()),
                new JProperty("reviewDate", OngoingReviewDate?.ToUniversalTime()))),
