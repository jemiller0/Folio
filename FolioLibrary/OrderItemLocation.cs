...
{
    [Table("location", Schema = "diku_mod_orders_storage")]
    public partial class OrderItemLocation
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.OrderItemLocation.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(OrderItemLocation), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
