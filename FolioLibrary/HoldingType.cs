...
{
    [Table("holdings_type", Schema = "uchicago_mod_inventory_storage")]
    public partial class HoldingType
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(HoldingType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static HoldingType FromJObject(JObject jObject) => jObject != null ? new HoldingType
        {
