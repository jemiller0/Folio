...
namespace FolioLibrary
{
    ...
    public partial class Fee2
    {
        ...
        public static Fee2 FromJObject(JObject jObject) => jObject != null ? new Fee2
        {
            ...
            DateCreated = ((DateTime?)jObject.SelectToken("dateCreated"))?.ToLocalTime(),
            DateUpdated = ((DateTime?)jObject.SelectToken("dateUpdated"))?.ToLocalTime(),
            ...
            ReturnedTime = ((DateTime?)jObject.SelectToken("returnedDate"))?.ToLocalTime(),
        ...
        public JObject ToJObject() => new JObject(
            ...
            new JProperty("dateCreated", DateCreated?.ToUniversalTime()),
            new JProperty("dateUpdated", DateUpdated?.ToUniversalTime()),
            ...
            new JProperty("returnedDate", ReturnedTime?.ToUniversalTime()),
