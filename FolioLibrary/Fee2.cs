...
{
    // uc.fees -> uchicago_mod_feesfines.accounts
    // Fee2 -> Fee
    ...
    public partial class Fee2
    {
        ...
        public static Fee2 FromJObject(JObject jObject) => jObject != null ? new Fee2
        {
            ...
            DateUpdated = ((DateTime?)jObject.SelectToken("dateUpdated"))?.ToUniversalTime(),
        ...
        public JObject ToJObject() => new JObject(
            ...
            new JProperty("dateUpdated", DateUpdated?.ToLocalTime()),
            ...
            new JProperty("returnedDate", ReturnedTime?.ToLocalTime()),
