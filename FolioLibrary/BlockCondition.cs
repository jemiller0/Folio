...
namespace FolioLibrary
{
    ...
    public partial class BlockCondition
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(BlockCondition), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public virtual ICollection<BlockLimit> BlockLimits { get; set; }
        ...
        public static BlockCondition FromJObject(JObject jObject) => jObject != null ? new BlockCondition
        {
