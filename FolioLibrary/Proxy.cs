...
namespace FolioLibrary
{
    ...
    public partial class Proxy
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Proxy.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Proxy), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
