...
{
    [Table("accounts", Schema = "diku_mod_feesfines")]
    public partial class Account
    {
        public static ValidationResult ValidateContent(string value)
        {
            ...
            using (var sr2 = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("FolioLibrary.Account.json")))
        ...
        [Column("jsonb"), CustomValidation(typeof(Account), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
