...
namespace FolioLibrary
{
    ...
    public partial class StaffSlip2
    {
        ...
        [Column("is_raw_html"), Display(Name = "Is Raw Html", Order = 5), JsonProperty("isRawHtml")]
        public virtual bool? IsRawHtml { get; set; }

        [Column("template"), Display(Order = 6), JsonProperty("template"), Required, StringLength(1024)]
        ...
        [Display(Name = "Creation User", Order = 8), InverseProperty("StaffSlip2s")]
        ...
        [Display(Name = "Last Write User", Order = 12), InverseProperty("StaffSlip2s1")]
        ...
        public static StaffSlip2 FromJObject(JObject jObject) => jObject != null ? new StaffSlip2
        {
            ...
            IsRawHtml = (bool?)jObject.SelectToken("isRawHtml"),
        ...
        public JObject ToJObject() => new JObject(
            ...
            new JProperty("isRawHtml", IsRawHtml),
