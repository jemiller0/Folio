...
{
    [Table("statistical_code_type", Schema = "uchicago_mod_inventory_storage")]
    public partial class StatisticalCodeType
    {
        ...
        [Column("jsonb"), CustomValidation(typeof(StatisticalCodeType), nameof(ValidateContent)), DataType(DataType.MultilineText), Display(Order = 2), Required]
        ...
        public static StatisticalCodeType FromJObject(JObject jObject) => jObject != null ? new StatisticalCodeType
        {
